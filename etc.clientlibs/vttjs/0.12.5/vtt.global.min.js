...
!(function (a) {
  ...
  return (function a(b, c, d) {
  ...
  })(
    {
        ...
        function (a, b) {
          ...
          function g(a, b, g) {
            function h() {
              var b = d(a);
              if (null === b)
                throw new c(c.Errors.BadTimeStamp, "Malformed timestamp: " + k);
            ...
            var k = a;
            if ((j(), (b.startTime = h()), j(), "-->" !== a.substr(0, 3)))
              throw new c(
                c.Errors.BadTimeStamp,
                "Malformed time stamp (time stamps must be separated by '-->'): " +
                  k
              );
            (a = a.substr(3)), j(), (b.endTime = h()), j(), i(a, b);
          }
          function h(a, b) {
            function c() {
              function a(a) {
            ...
            function g(a, b) {
              return !u[b.localName] || u[b.localName] === a.localName;
            }
            function h(b, c) {
              var d = s[b];
              if (!d) return null;
          ...
          function j(a) {
            ...
            for (b(e, a); (f = c(e)); )
              for (var g = 0; g < f.length; g++)
                if (((d = f.charCodeAt(g)), i(d))) return "rtl";
            return "ltr";
          }
          function k(a) {
            if (
            ...
            d ||
              ((g.writingMode =
                "" === b.vertical
                  ...
                  ? "vertical-lr"
                  : "vertical-rl"),
              (g.unicodeBidi = "plaintext")),
              this.applyStyles(g, this.cueDiv),
          ...
          function o(a, b, c, d) {
            function e(a, b) {
              for (var e, f = new n(a), g = 1, h = 0; h < b.length; h++) {
                for (
                  ;
            ...
            if (g.snapToLines) {
              ...
              var l = f.lineHeight,
                ...
                p = i[0];
              Math.abs(m) > o &&
                ((m = 0 > m ? -1 : 1), (m *= Math.ceil(o / l) * l)),
                0 > h &&
                  ((m += "" === g.vertical ? c.height : c.width),
                  (i = i.reverse())),
                f.move(p, m);
            } else {
          ...
          (l.prototype.applyStyles = function (a, b) {
            b = b || this.div;
            for (var c in a) a.hasOwnProperty(c) && (b.style[c] = a[c]);
          }),
            (l.prototype.formatStyle = function (a, b) {
              return 0 === a ? 0 : a + b;
            }),
            (m.prototype = q(l.prototype)),
            (m.prototype.constructor = m),
            (n.prototype.move = function (a, b) {
            ...
            (n.prototype.overlaps = function (a) {
              return (
                this.left < a.right &&
                this.right > a.left &&
                this.top < a.bottom &&
            ...
            (n.prototype.overlapsAny = function (a) {
              for (var b = 0; b < a.length; b++)
                if (this.overlaps(a[b])) return !0;
              return !1;
            }),
            (n.prototype.within = function (a) {
              return (
                this.top >= a.top &&
            ...
            (n.prototype.overlapsOppositeAxis = function (a, b) {
              switch (b) {
                case "+x":
            ...
            (n.prototype.intersectPercentage = function (a) {
              var b = Math.max(
                  0,
            ...
            (n.prototype.toCSSCompatValues = function (a) {
              return {
                top: this.top - a.top,
            ...
            (n.getSimpleBoxPosition = function (a) {
              var b = a.div
                  ? a.div.offsetHeight
                  : a.tagName
                  ? a.offsetHeight
            ...
            (p.convertCueToDOMTree = function (a, b) {
              return a && b ? h(a, b) : null;
            });
          var w = 0.05,
            x = "sans-serif",
            y = "1.5%";
          (p.processCues = function (a, b, c) {
            function d(a) {
              for (var b = 0; b < a.length; b++)
            ...
            if (
              ...
              var f = [],
                g = n.getSimpleBoxPosition(e),
                h = Math.round(g.height * w * 100) / 100,
                i = { font: h + "px " + x };
              !(function () {
                for (var c, d, h = 0; h < b.length; h++)
                  (d = b[h]),
                    ...
                    f.push(n.getSimpleBoxPosition(c));
              })();
            } else
              for (var j = 0; j < b.length; j++)
                e.appendChild(b[j].displayState);
          }),
            (p.Parser = function (a, b, c) {
              c || ((c = b), (b = {})),
                b || (b = {}),
                (this.window = a),
                (this.vttjs = b),
              ...
              parse: function (a) {
                ...
                try {
                  ...
                  if ("INITIAL" === k.state) {
                    ...
                    if (!m || !m[0]) throw new c(c.Errors.BadSignature);
                    k.state = "HEADER";
                  }
                  for (var n = !1; k.buffer; ) {
                    if (!/\r\n|\n/.test(k.buffer)) return this;
                    switch ((n ? (n = !1) : (l = b()), k.state)) {
                      case "HEADER":
      ...
      5: [
        function (a, b) {
          var c = a("global/window"),
            d = (b.exports = {
              WebVTT: a("./vtt.js"),
              VTTCue: a("./vttcue.js"),
              VTTRegion: a("./vttregion.js"),
            });
          (c.vttjs = d), (c.WebVTT = d.WebVTT);
          var e = d.VTTCue,
            f = d.VTTRegion,
            g = c.VTTCue,
            h = c.VTTRegion;
          (d.shim = function () {
            (c.VTTCue = e), (c.VTTRegion = f);
          }),
            (d.restore = function () {
              (c.VTTCue = g), (c.VTTRegion = h);
            }),
            c.VTTCue || d.shim();
        },
        {
