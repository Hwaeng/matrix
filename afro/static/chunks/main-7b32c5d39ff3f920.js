(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [179],
  {
    ...
    7339: function (e, t, r) {
                    ...
                    (T.isFallback ||
                      (T.nextExport &&
                        (_.isDynamicRoute(h.pathname) ||
                          location.search ||
                          V)) ||
                      (T.props && T.props.__N_SSG && (location.search || V))) &&
                    h
                      .replace(
                        h.pathname +
                          "?" +
                  ...
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        ...
                        T.scriptLoader &&
                          (0, r(699).initScriptLoader)(T.scriptLoader),
                        (D = new E.default(T.buildId, t)),
                        (n = function (e) {
                          var t = c(e, 2),
                            r = t[0],
                            n = t[1];
      ...
      var Y = function (e) {
        return function (t) {
          var r = d({}, t, { Component: W, err: T.err, router: h });
              ...
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 14:
                      return (
                        (e.next = 16), D.routeLoader.whenEntrypoint(T.page)
                      );
                    case 16:
                      e.t0 = e.sent;
                    case 17:
                    ...
                    case 30:
                      ...
                      return (
                        (e.next = 34), window.__NEXT_PRELOADREADY(T.dynamicIds)
                      );
                    case 34:
                      return (
                        (t.router = h =
                          k.createRouter(T.page, T.query, I, {
                  ...
                  switch ((e.prev = e.next)) {
                    ...
                    case 9:
                      if (
                        ((e.prev = 9),
                        (e.t0 = e.catch(4)),
                        !(r = M.getProperError(e.t0)).cancelled)
                      ) {
                        e.next = 14;
                        break;
                      }
              ...
              v.default.createElement(
                C.ImageConfigContext.Provider,
                {
                  value: {
                    ...
                    path: "https://res.cloudinary.com/mazarine-digital/image/upload/",
                    loader: "cloudinary",
              ...
              (this.onPopState = function (e) {
                ...
                if (r) {
                  if (r.__NA) window.location.reload();
                    ...
                    r.__N &&
                    (!t || g.locale !== r.options.locale || r.as !== g.asPath)
                  ) {
                    var n = r.url,
                      a = r.as,
                      o = r.options,
                        ...
                        function (u) {
                          for (;;)
                            switch ((u.prev = u.next)) {
                              ...
                              case 47:
                                return (
                                  e.events.emit("hashChangeComplete", n, F),
                                  u.abrupt("return", !0)
                                );
                              case 49:
                                return (
                                  ($ = w.parseRelativeUrl(r)),
                                  (X = $.pathname),
                                  (Y = $.query),
                                  (u.prev = 52),
                                  (u.t1 = i),
                              ...
                              case 68:
                                return (
                                  ...
                                  (re = n),
                                  (X = X
                                    ? p.removeTrailingSlash(R.removeBasePath(X))
                                    : X),
                                  (u.next = 73),
                              ...
                              case 82:
                                ne || (re = ae.asPath),
                                  ae.matchedPage &&
                                    ae.resolvedHref &&
                                    ((X = ae.resolvedHref),
                                    ($.pathname = L.addBasePath(X)),
                                    ne || (r = O.formatWithValidation($))),
                                  (u.next = 87);
                                break;
                              case 86:
                                ($.pathname = W(X, Q)),
                                ...
                                if (
                                  ("route" in (ve = u.sent) &&
                                    ...
                                    P.isDynamicRoute(X) &&
                                      ...
                                      (ye = me),
                                      A.hasBasePath(ye) &&
                                        (ye = R.removeBasePath(ye)),
                                      (ge = j.getRouteRegex(X)),
                                      (_e = E.getRouteMatcher(ge)(ye)) &&
                                        Object.assign(Y, _e))),
                                  !("type" in ve))
                                ) {
                                  u.next = 124;
                              ...
                              case 124:
                                if (
                                  ...
                                  (Se = ve.Component) &&
                                    ...
                                    []
                                      .concat(Se.unstable_scriptLoader())
                                      .forEach(function (e) {
                                ...
                                return (
                                  ((je = w.parseRelativeUrl(Ee)).pathname = W(
                                    je.pathname,
                                    Q,
                                  )),
                                  (Oe = U(l, Ee, Ee)),
                              ...
                              case 155:
                                if (
                                  ...
                                  a._h &&
                                    ...
                                    !g &&
                                    !V &&
                                    I.compareRouterStates(Ie, l.state))
                                ) {
                                  u.next = 176;
                                  break;
                                }
                              ...
                              case 169:
                                ...
                                throw (
                                  (f ||
                                    e.events.emit("routeChangeError", be, G, F),
                                  be)
                                );
                              case 172:
                                0,
                                  f ||
                                    e.events.emit("routeChangeComplete", n, F),
                                  (qe = /#.+$/),
                                  Ne && qe.test(n) && l.scrollToHash(n);
                              case 176:
                ...
                value: function (e) {
                  ...
                  return c(
                    u.default.mark(function e() {
                      var y, _, b, x, S, E, j, k, M, C, L, A, N, T, I;
                      return u.default.wrap(
                        function (e) {
                          for (;;)
                            switch ((e.prev = e.next)) {
                              ...
                              case 64:
                                return (
                                  ...
                                  e.abrupt(
                                    "return",
                                    v.handleRouteInfoError(
                                      m.getProperError(e.t3),
                                      r,
                                      n,
                                      a,
                                      i,
                    ...
                    if (o) {
                      ...
                      var d = k.parsePath(e),
                        v = T.formatNextPathnameInfo(
                          s(
                            {},
                            N.getNextPathnameInfo(d.pathname, {
                              nextConfig: n,
                              parseData: !0,
                            }),
                            {
                      ...
                      if (m.startsWith("/")) {
                        var y = k.parsePath(m),
                          _ = T.formatNextPathnameInfo(
                            s(
                              {},
                              N.getNextPathnameInfo(y.pathname, {
                                nextConfig: n,
                                parseData: !0,
                              }),
                              {
                ...
                q = function (e, t) {
                  ...
                  var r,
                    ...
                    a = function (e) {
                      ...
                      var t,
                        a =
                          ((t = Math.min(I.length - 1, Math.floor(T() / 50))),
                          I[t]);
                      a &&
                        a.latency !== n.value &&
