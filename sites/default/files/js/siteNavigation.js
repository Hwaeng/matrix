(function (n, t) {
    ...
    return (
      n.Link && n.Link.Url
        ? ((u = t.createElement("a")),
          ...
          u.classList.add("nav-2023-link", "type-navigation", "text-elevated"),
          (u.innerHTML = i(n)))
        : ((r = t.createElement("button")),
          r.classList.add("nav-2023-link", "type-navigation", "text-elevated"),
          (r.innerHTML = i(n))),
      n.ChildLinks &&
  ...
  function tt(n) {
    ...
    const e = { Link: { Text: "overview", Url: f(n) } },
      s = o(e);
    return (
      s.forEach((n) => {
        u.appendChild(n);
        ...
        if (o) {
          if (
            ...
            !t
              ...
              .previousElementSibling.classList.contains("nav-2023-close-item")
          ) {
            n.preventDefault();
