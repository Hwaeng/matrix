...
(function ($, Drupal, debounce) {
  ...
  Drupal.behaviors.views_infinite_scroll_automatic = {
    attach: function (context, settings) {
      once("infinite-scroll", automaticPagerSelector, context).forEach(
        function (elem) {
          var $pager = $(elem);
    ...
    detach: function (context, settings, trigger) {
      ...
      if (trigger === "unload") {
        if (
          once.remove("infinite-scroll", automaticPagerSelector, context).length
        ) {
          $window.off(scrollEvent);
        }
      }
  ...
  Drupal.views.ajaxView.prototype.filterNestedViews = function () {
    return (
      this.$view.hasClass("view-eva") || !this.$view.parents(".view").length
    );
  };
