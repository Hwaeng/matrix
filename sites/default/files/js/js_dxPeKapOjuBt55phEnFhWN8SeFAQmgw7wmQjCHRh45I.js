...
!(function (e, t, n) {
  ...
  function g(e, t, o, i) {
    ...
    for (
      var c, d, p, m, h, g = ["modernizr", "tspan", "samp"];
      !L.style && g.length;

    )
      (c = !0), (L.modElem = s(g.shift())), (L.style = L.modElem.style);
  ...
  var N = "Moz O ms Webkit",
    P = S._config.usePrefixes ? N.toLowerCase().split(" ") : [];
  S._domPrefixes = P;
  var j;
  !(function () {
  ...
  S.hasEvent = z;
  var T = S._config.usePrefixes ? N.split(" ") : [];
  S._cssomPrefixes = T;
  var k = function (t) {
    var r,
      o = b.length,
  ...
  S.atRule = k;
  var F = ((S.testStyles = c), { elem: s("modernizr") });
  Modernizr._q.push(function () {
    delete F.elem;
  });
  var L = { style: F.elem.style };
  ...
  (S.testAllProps = C), o(), i(_), delete S.addTest, delete S.addAsyncTest;
