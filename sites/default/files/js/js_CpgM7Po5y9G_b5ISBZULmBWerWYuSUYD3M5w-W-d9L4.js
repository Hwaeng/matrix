...
(function ($, Drupal) {
  $(function () {
    // Open the Modal
    function openModal() {
      $("#myModalLogo").fadeIn(300);
    }

    // Close the Modal
    function closeModal() {
      $("#myModalLogo").fadeOut(300);
    }
    ...
    var $owl = $(".JPlogoCarousel:not(.listing)").owlCarousel({
      items: 3,
      loop: false,
      center: false,
      margin: 45,
    ...
    $("a.JPlogoCarouselListContent").on("click", function (e) {
      openModal();
      currentSlide($(this).data("delta"));
    });

    $("#myModalLogo span.close").on("click", function (e) {
      closeModal();
    });

    $(".JPlogoCarouselPopupPagination a.next").on("click", function (e) {
      plusSlides(1, "slide");
    });

    $(".JPlogoCarouselPopupPagination a.prev").on("click", function (e) {
      plusSlides(-1, "slide");
    });
    ...
    $(".modal-content-inner").on("swipeleft", function () {
      plusSlides(-1, "slide");
    });

    $(".modal-content-inner").on("swiperight", function () {
      plusSlides(1, "slide");
    });
  });
})(jQuery, Drupal);
