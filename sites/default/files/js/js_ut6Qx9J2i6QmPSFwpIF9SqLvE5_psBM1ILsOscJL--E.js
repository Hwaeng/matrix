                  ...
                  templates: {
                    item({ item, components, html }) {
                      if (item.thumbnail == "") {
                        item.thumbnail =
                          drupalSettings.path.baseUrl +
                          "/themes/custom/petronas/images/search-placeholder.png";
                      }
...
(function ($, Drupal) {
  $(function () {
    const $paragraphClass = ".paragraph--type--inner-two-column-carousel";
    var slideIndex = 1;

    var $owl = $($paragraphClass + " .JpassionRow6").owlCarousel({
      items: 1,
      loop: true,
      center: true,
      nav: false,
      dots: true,
      dotsContainer: $paragraphClass + " .slider-dots",
      slideBy: 1,
      mouseDrag: true,
      touchDrag: true,
    ...
    $($paragraphClass + " .slider-prev").on("click", function () {
      $owl.trigger("prev.owl.carousel");
    });

    $($paragraphClass + " .slider-next").on("click", function () {
...
(function ($, Drupal) {
  $(function () {
    const $paragraphClass = ".paragraph--type--inner-one-column-carousel";
    var slideIndex = 1;

    var $owlIcons = $($paragraphClass + " .slider-icons").owlCarousel({
      items: 3,
      loop: true,
      center: true,
      margin: 100,
    ...
    var $owlContent = $($paragraphClass + " .slider-content").owlCarousel({
      items: 1,
      loop: true,
      center: true,
      nav: false,
      ...
      autoplay: false,
      smartSpeed: 100,
      animateOut: "animate__fadeOut animate__faster",
      animateIn: "animate__fadeIn animate__faster",
      startPosition: "URLHash",
    });

    $owlContent.on("changed.owl.carousel", function (event) {
      var index = event.item.index;
      $owlIcons.trigger("to.owl.carousel", [index - 3, 300]);
    });
