...
(n = this),
  (t = function () {
    ...
    function w(n, t, i) {
      if (n)
        for (var r = fn(n), r = i ? r.reverse() : r, u = 0; u < r.length; u++) {
          var o = r[u];
    ...
    function an(r) {
      return (
        u(arguments, 1).forEach(function (i) {
          w(i, function (n, t) {
            r[t] = i[t];
          });
        }),
    ...
    function R(i, t, r) {
      tn(t)
        ...
        : m(i, function (n) {
            e(r) || "" === r ? I(n, t) : n.setAttribute(t, String(r));
          });
    }
    function C(n, t, i) {
      n = document.createElement(n);
      return t && (P(t) ? z : R)(n, t), i && L(i, n), n;
    }
    function O(n, t, i) {
      if (rn(i)) return getComputedStyle(n)[t];
      e(i) || (n.style[t] = "" + i);
    }
    function ln(n, t) {
      O(n, "display", t);
    ...
    function hn(n) {
      return cn(new DOMParser().parseFromString(n, "text/html").body);
    }
    function F(n, t) {
      n.preventDefault(),
    ...
    function Mn() {
      ...
      return {
        bind: function (n, t, o, e) {
          i(n, t, function (n, t, i) {
            var r = "addEventListener" in n,
              u = r
                ? n.removeEventListener.bind(n, t, o, e)
                : n.removeListener.bind(n, o);
            r ? n.addEventListener(t, o, e) : n.addListener(o),
              c.push([n, t, i, o, u]);
          });
        },
        unbind: function (n, t, u) {
    ...
    function K(n) {
      var i = n ? n.event.bus : document.createDocumentFragment(),
        r = Mn();
      return (
        n && n.event.on(f, r.destroy),
        an(r, {
          bus: i,
          on: function (n, t) {
            r.bind(i, g(n).join(" "), function (n) {
              t.apply(t, o(n.detail) ? n.detail : []);
            });
          },
          off: D(r.unbind, i),
          emit: function (n) {
            r.dispatch(i, n, u(arguments, 1));
          },
        })
      );
    }
    function Hn(t, n, i, r) {
      ...
      function d() {
        o && cancelAnimationFrame(o), (f = !(o = c = 0));
      }
      return {
        start: function (n) {
          n || d(), (u = e() - (n ? c * t : 0)), (f = !1), h(s);
        },
        rewind: function () {
          (u = e()), (c = 0), i && i(c);
        },
    ...
    var V = "role",
      ...
      $n = t + "hidden",
      nt = t + "orientation",
      tt = t + "roledescription",
      it = t + "live",
      rt = t + "busy",
      ut = t + "atomic",
      ot = [V, Jn, "disabled", Kn, Vn, Q, Zn, $n, nt, tt],
      et = _,
      ct = _ + "__track",
      ft = _ + "__list",
      at = _ + "__slide",
    ...
    function It(u, r, t, o) {
      ...
      function E() {
        ...
        e ||
          ((n = u.index),
          (i = S()) !== vn(o, Z) &&
            (A(o, Z, i), R(o, Vn, (d && i) || ""), c(i ? In : Rn, L)),
          (i = (function () {
            if (u.is(zt)) return S();
            var n = j(a.Elements.track),
              t = j(o),
              i = m("left", !0),
              r = m("right", !0);
            return wn(n[i]) <= _n(t[i]) && wn(t[r]) <= _n(n[r]);
          })()),
          (t = !i && (!S() || w)),
          u.state.is([G, $]) || R(o, $n, t || ""),
          R(gn(o, l.focusableNodes || ""), Jn, t ? -1 : ""),
          g && R(o, Jn, t ? -1 : 0),
          i !== vn(o, kt) && (A(o, kt, i), c(i ? Cn : Tn, L)),
          i ||
            document.activeElement !== o ||
            ((t = a.Slides.getAt(u.index)) && dn(t.slide)),
          A(o, _t, r === n - 1),
          A(o, xt, r === n + 1));
      }
      function S() {
      ...
      var L = {
        ...
        mount: function () {
          w ||
            ((o.id = s.id + "-slide" + An(r + 1)),
            R(o, V, p ? "tabpanel" : "group"),
            R(o, tt, h.slide),
            R(o, Q, b || Ln(h.slideLabel, [r + 1, u.length]))),
            f(o, "click", D(c, zn, L)),
            f(o, "keydown", D(c, jn, L)),
            i([Dn, Pn, J], E),
            i(Fn, x),
            v && i(U, k);
        },
        ...
        isWithin: function (n, t) {
          return (
            (n = Y(n - r)),
            (n = w || (!l.rewind && !u.is(Pt)) ? n : X(n, u.length - n)) <= t
          );
        },
      };
      return L;
    ...
    var Rt = c + "-interval";
    var Ct = { passive: !1, capture: !0 };
    var Tt = { Spacebar: " ", Right: qn, Left: Un, Up: s, Down: n };
    function jt(n) {
      return (n = P(n) ? n : n.key), Tt[n] || n;
    }
    var Nt = "keydown";
    var Gt = c + "-lazy",
      Ft = Gt + "-srcset",
    ...
    var Yt = Object.freeze({
        ...
        Media: function (r, n, u) {
          ...
          function s() {
            ...
            sn(u),
              l(i),
              u.destroy
                ? r.destroy("completely" === u.destroy)
                : n
                  ? (f(!0), r.mount())
                  : t !== u.direction && r.refresh();
          }
          function l(n, t) {
            d(u, n),
              t && d(Object.getPrototypeOf(u), n),
              o.is(1) || r.emit(B, u);
          }
          return {
            setup: function () {
            ...
            destroy: f,
            reduce: function (n) {
              matchMedia(v).matches && (n ? d(u, e) : sn(u, fn(e)));
            },
            set: l,
          };
        },
        Direction: function (n, t, u) {
          return {
            resolve: function (n, t, i) {
              var r =
                "rtl" !== (i = i || u.direction) || t ? (i === Bn ? 0 : -1) : 1;
              return (
                (l[n] && l[n][r]) ||
        ...
        Elements: function (n, t, i) {
          ...
          function p() {
            (r = y("." + ct)),
              (u = cn(r, "." + ft)),
              yn(r && u, "A track/list element is missing."),
              S(d, en(u, "." + at + ":not(." + st + ")")),
              w(
                {
                  arrows: dt,
              ...
              an(l, { root: a, track: r, list: u, slides: d });
            var n =
                a.id ||
                (function (n) {
                  return "" + n + An((On[n] = (On[n] || 0) + 1));
                })(_),
              t = i.role;
            (a.id = n),
              (r.id = r.id || n + "-track"),
              (u.id = u.id || n + "-list"),
              !T(a, V) && "SECTION" !== a.tagName && t && R(a, V, t),
              R(a, tt, s.carousel),
              R(u, V, "presentation"),
              m();
          }
          function g(n) {
            ...
            M(d), W(a, v), W(r, h), I([r, u], t), I(a, n ? t : ["style", tt]);
          }
          function m() {
            W(a, v),
              W(r, h),
          ...
          function y(n) {
            ...
            return n &&
              (function (n, t) {
                if (E(n.closest)) return n.closest(t);
                for (var i = n; i && 1 === i.nodeType && !on(i, t); )
                  i = i.parentElement;
                return i;
              })(n, "." + et) === a
              ? n
          ...
          function p(t) {
            return s.filter(
              E(t)
                ? t
                : function (n) {
                    return P(t) ? on(n.slide, t) : b(g(t), n.index);
                  },
            );
          }
          return {
        ...
        Layout: function (n, t, i) {
          ...
          function p() {
            (u = null),
              (r = i.direction === Bn),
              O(s, "maxWidth", x(i.width)),
              O(l, a("paddingLeft"), m(!1)),
              O(l, a("paddingRight"), m(!0)),
              g();
          }
          function g() {
            var n = j(s);
            (u && u.width === n.width && u.height === n.height) ||
              (O(
                ...
                (function () {
                  var n = "";
                  r &&
                    (yn((n = y()), "height or heightRatio is missing."),
                    (n = "calc(" + n + " - " + m(!1) + " - " + m(!0) + ")"));
                  return n;
                })(),
              ),
              h(a("marginRight"), x(i.gap)),
              h(
                "width",
                i.autoWidth ? null : x(i.fixedWidth) || (r ? "" : b()),
              ),
              h(
                "height",
                x(i.fixedHeight) || (r ? (i.autoHeight ? null : b()) : y()),
                !0,
              ),
              (u = n),
              c(Nn));
          ...
          function m(n) {
            var t = i.padding,
              n = a(n ? "right" : "left");
            return (t && x(t[n] || (tn(t) ? 0 : t))) || "0px";
          }
          function y() {
            return x(i.height || j(d).width * i.heightRatio);
          }
          function b() {
            var n = x(i.gap);
            return (
          ...
          function _() {
            var n = v(0);
            return (n && parseFloat(O(n.slide, a("marginRight")))) || 0;
          }
          return {
            mount: function () {
              var n, t, i;
            ...
            getPadding: function (n) {
              return (
                parseFloat(O(l, a("padding" + (n ? "Right" : "Left")))) || 0
              );
            },
          };
        },
          ...
          function o() {
            if ((n = h())) {
              var u = n,
                ...
                e = o.length;
              if (e) {
                for (; o.length < u; ) S(o, o);
                S(o.slice(-u), o.slice(0, u)).forEach(function (n, t) {
                  var i = t < u,
                    r = (function (n, t) {
                      n = n.cloneNode(!0);
                      return (
                  ...
                  i ? un(r, o[0].slide) : L(s.list, r),
                    S(d, r),
                    l.register(r, t - u + (i ? 0 : e), n.index);
                });
              }
              a(k);
            }
          ...
          function h() {
            ...
            return (
              c.is(Pt)
                ? t ||
                  (t =
                    ((n = f[u("fixedWidth")] && i.Layout.slideSize(0)) &&
                      _n(j(s.track)[u("width")] / n)) ||
                    (f[u("autoWidth")] && c.length) ||
                    2 * f.perPage)
                : (t = 0),
              t
            );
        ...
        Move: function (r, c, u) {
          ...
          function b(n, t) {
            r.is(zt) ||
              ...
              O(p, "transform", "translate" + v("X") + "(" + t + "px)"),
              n !== t && f(Pn));
          }
          function w(n, t) {
            var i = n - S(t),
              r = d();
            return (n -= h(r * (_n(Y(i) / r) || 1)) * (t ? 1 : -1));
          }
          function _() {
            b(E()), e.cancel();
          }
          ...
          function k(n, t) {
            ...
            return t
              ? ((n = i),
                (n = u.trimSpace && r.is(Dt) ? En(n, 0, h(d() - l())) : n))
              : i;
          }
          function E() {
            var n = v("left");
            return j(p)[n] - j(g)[n] + h(i(!1));
          }
          function S(n) {
            return k(n ? c.Controller.getEnd() : 0, !!u.trimSpace);
          }
          return {
            mount: function () {
              (e = c.Transition), t([H, Nn, B, q], m);
            },
            move: function (n, t, i, r) {
              ...
              n !== t &&
                ((u = i < n),
                (o = h(w(E(), u))),
                u ? 0 <= o : o <= p[v("scrollWidth")] - j(g)[v("width")]) &&
                (_(), b(w(E(), i < n), !0)),
                a(G),
                f(U, t, i, n),
                e.start(t, function () {
        ...
        Controller: function (o, u, e) {
          var c,
            ...
            b = y;
          function w() {
            (c = i(!0)), (f = e.perMove), (a = e.perPage);
            var n = En(y, 0, c - 1);
            n !== y && ((y = n), s.reposition());
          }
          function _(n, t) {
            var i = f || (O() ? 1 : a),
              i = x(y + i * (n ? -1 : 1), y, !(f || O()));
            return -1 === i && p && !xn(l(), r(!n), 1)
              ? n
                ? 0
                : E()
              : t
          ...
          function x(n, t, i) {
            ...
            return (
              v() || O()
                ? ((r = E()),
                  (u = (function (n) {
                    if (p && "move" === e.trimSpace && n !== y)
                      for (
                        var t = l();
                        t === d(n, !0) && kn(n, 0, o.length - 1, !e.rewind);
          ...
          function E() {
            return bn(c - (O() || (h && f) ? 1 : a), 0);
          }
          function S(n) {
            return En(O() ? n : a * n, 0, E());
          }
          function L(n) {
            return O() ? n : wn((n >= E() ? c - 1 : n) / a);
          }
          function A(n) {
            n !== y && ((b = y), (y = n));
          }
          function O() {
            return !rn(e.focus) || e.isNavigation;
          }
          function M() {
            return o.state.is([G, $]) && !!e.waitForTransition;
          }
          return {
            mount: function () {
              w(), n([B, q], w);
            ...
            toPage: L,
            toDest: function (n) {
              return (n = s.toIndex(n)), p ? En(n, 0, E()) : n;
            },
            hasFocus: O,
            isBusy: M,
          };
        },
        Arrows: function (u, n, t) {
          var i,
            r,
            o = K(u),
            e = o.on,
          ...
          function E() {
            var n = u.index,
              t = d.getPrev(),
              i = d.getNext(),
              r = -1 < t && n < t ? s.last : s.prev,
              n = -1 < i && i < n ? s.first : s.next;
            (g.disabled = t < 0),
              (m.disabled = i < 0),
              R(g, Q, r),
              R(m, Q, n),
              f("arrows:updated", g, m, t, i);
          }
          return { arrows: y, mount: b, destroy: _, update: E };
        },
        Autoplay: function (n, t, i) {
          var r,
            ...
            c = o.bind,
            f = o.emit,
            a = Hn(i.interval, n.go.bind(n, ">"), function (n) {
              var t = l.bar;
              t && O(t, "width", 100 * n + "%"), f("autoplay:playing", n);
            }),
            s = a.isPaused,
            l = t.Elements,
            d = (o = t.Elements).root,
          ...
          function g() {
            s() &&
              t.Slides.isEnough() &&
              (a.start(!i.resetProgress), (u = r = p = !1), b(), f(Wn));
          }
          function m(n) {
          ...
          function b() {
            v && (A(v, Z, !p), R(v, Q, i.i18n[p ? "play" : "pause"]));
          }
          function w(n) {
            n = t.Slides.getAt(n);
            a.set((n && +T(n.slide, Rt)) || i.interval);
          }
          return {
            mount: function () {
              h &&
        ...
        Cover: function (n, t, i) {
          ...
          function u(i) {
            t.Slides.forEach(function (n) {
              var t = cn(n.container || n.slide, "img");
              t && t.src && o(i, t, n);
            });
          }
          function o(n, t, i) {
          ...
          return {
            mount: function () {
              i.cover && (r(Yn, D(o, !0)), r([H, B, q], D(u, !0)));
            },
            destroy: D(u, !1),
          };
        },
        Scroll: function (n, c, o) {
          var f,
            a,
            t = K(n),
            i = t.on,
            ...
            var o,
              ...
              i =
                ...
                !i ||
                  ...
                  (o = Sn(n) * i * wn(Y(n) / i) || 0),
                  (n = d.toPosition(c.Controller.toDest(n % i)) + o)),
                xn(e, n, 1));
            (m = 1),
              (t = i ? 0 : t || bn(Y(n - e) / 1.5, 800)),
              (a = r),
              (f = Hn(t, b, D(w, e, n, u), 1)),
              l($),
              s(Gn),
              f.start();
          }
            ...
            var u = v(),
              r =
                (n +
                  (t - n) *
                    ((t = r),
                    (n = o.easingFunc) ? n(t) : 1 - Math.pow(1 - t, 4)) -
                  u) *
                m;
            p(u + r),
              g &&
                !i &&
                h() &&
                ((m *= 0.6), Y(r) < 10 && y(e(h(!0)), 600, !1, a, !0));
          }
          function _() {
            f && f.cancel();
          }
        ...
        Drag: function (e, u, c) {
          ...
          function A(n) {
            ...
            m.is(6) || (m.set(6), h("drag")),
              n.cancelable &&
                (s
                  ? (y.translate(f + D(n) / (L && e.is(Dt) ? 5 : 1)),
                    (o = 200 < P(n)),
                    (t = L !== (L = S())),
                    (o || t) && M(n),
                    (l = !0),
              ...
              s &&
                ((i = (function (n) {
                  return (
                    ...
                    Sn(n) *
                      X(
                        Y(n) * (c.flickPower || 600),
                        a
                          ? 1 / 0
                          : u.Layout.listSize() * (c.flickMaxPages || 1),
                      )
                  );
                })(
                  (t = (function (n) {
        ...
        Keyboard: function (t, n, i) {
          ...
          function l() {
            var n = i.keyboard;
            n && ((r = "global" === n ? window : a), c(r, Nt, h));
          }
          function d() {
            f(r, Nt);
          }
          ...
          function h(n) {
            u || ((n = jt(n)) === s(Un) ? t.go("<") : n === s(qn) && t.go(">"));
          }
          return {
            mount: function () {
              l(), e(B, d), e(B, l), e(U, v);
        ...
        LazyLoad: function (i, n, u) {
          var t = K(i),
            r = t.on,
            o = t.off,
            e = t.bind,
            c = t.emit,
            f = "sequential" === u.lazyLoad,
            a = [Dn, J],
            s = [];
          function l() {
            M(s),
              n.Slides.forEach(function (r) {
                gn(r.slide, Wt).forEach(function (n) {
                  ...
                  (t === n.src && i === n.srcset) ||
                    ((t = u.classes.spinner),
                    (t = cn((i = n.parentElement), "." + t) || C("span", t, i)),
                    s.push([n, r, t]),
                    n.src || ln(n, "none"));
                });
              }),
          ...
          function h(n, t) {
            var i = n[0],
              r = n[1];
            W(r.slide, Et),
              "error" !== t.type && (N(n[2]), ln(i, ""), c(Yn, i, r), c(k)),
              f && p();
          }
          function p() {
            s.length && v(s.shift());
        ...
        Pagination: function (l, n, d) {
          var v,
            ...
            x = [];
          function k() {
            v && (N(_ ? u(v.children) : v), W(v, h), M(x), (v = null)),
              t.destroy();
          }
          function E(n) {
            e(">" + n, !0);
          ...
          function O() {
            var n,
              t = A(r(!0)),
              i = A(r());
            t && (W((n = t.button), Z), I(n, Qn), R(n, Jn, -1)),
              i && (z((n = i.button), Z), R(n, Qn, !0), R(n, Jn, "")),
              g("pagination:updated", { list: v, items: x }, t, i);
          }
          return {
            items: x,
            mount: function n() {
              k(), p([B, q], n);
              var t = d.pagination && y.isEnough();
              if ((_ && ln(_, t ? "" : "none"), t)) {
                p([U, Gn, J], O);
                var t = l.length,
                  i = d.classes,
                  ...
                  o = w() ? t : _n(t / u);
                z(
                  (v = _ || C("ul", i.pagination, b.track.parentElement)),
                  (h = gt + "--" + L()),
                ),
                  R(v, V, "tablist"),
                  R(v, Q, r.select),
                  R(v, nt, L() === Bn ? "vertical" : "");
                for (var e = 0; e < o; e++) {
                  var c = C("li", null, v),
                    f = C("button", { class: i.page, type: "button" }, c),
                    a = y.getIn(e).map(function (n) {
                      return n.slide.id;
                    }),
                    s = !w() && 1 < u ? r.pageX : r.slideX;
                  m(f, "click", D(E, e)),
                    d.paginationKeyboard && m(f, "keydown", D(S, e)),
                    R(c, V, "presentation"),
                    R(f, V, "tab"),
                    R(f, Kn, a.join(" ")),
                    R(f, Q, Ln(s, e + 1)),
                    R(f, Jn, -1),
                    x.push({ li: c, button: f, page: e });
                }
                O(), g("pagination:mounted", { list: v, items: x }, A(l.index));
              }
            },
            destroy: k,
            getAt: A,
        ...
        Sync: function (i, n, t) {
          ...
          function f(n, r) {
            n = K(n);
            n.on(U, function (n, t, i) {
              r.go(r.is(Pt) ? i : n);
            }),
              o.push(n);
          }
          function a() {
            R(n.Elements.list, nt, t.direction === Bn ? "vertical" : "");
          }
          function s(n) {
            i.go(n.index);
          }
        ...
        Wheel: function (e, c, f) {
          ...
          function t(n) {
            ...
            n.cancelable &&
              ...
              (u = f.wheelSleep || 0),
              Y(o) > r && u < i - a && (e.go(t ? "<" : ">"), (a = i)),
              (o = t),
              (f.releaseWheel &&
                !e.state.is(G) &&
                -1 === c.Controller.getAdjacent(o)) ||
                F(n));
          }
          return {
            mount: function () {
              f.wheel && n(c.Elements.track, "wheel", t, Ct);
            },
          };
        },
        Live: function (n, t, i) {
          var r = K(n).on,
            u = t.Elements.track,
            o = i.live && !i.isNavigation,
            e = C("span", wt),
            c = Hn(90, D(f, !1));
          function f(n) {
            R(u, rt, n), n ? (L(u, e), c.start()) : N(e);
          }
          function a(n) {
            o && R(u, it, n ? "off" : "polite");
          }
          return {
            mount: function () {
              o &&
    ...
    t = (function () {
      function i(n, t) {
        (this.event = K()),
          ...
          (this.n = {}),
          (this.t = {});
        n = P(n) ? pn(document, n) : n;
        yn(n, n + " is invalid."),
          (t = d(
            { label: T((this.root = n), Q) || "", labelledby: T(n, Zn) || "" },
            Ht,
            i.defaults,
            t || {},
          ));
        try {
          d(t, JSON.parse(T(n, c)));
        } catch (n) {
          yn(!1, "Invalid JSON");
        }
      ...
      return (
        (n.mount = function (n, t) {
          var i = this,
            ...
            u = this.Components;
          return (
            yn(r.is([1, 7]), "Already mounted!"),
            r.set(1),
            (this.i = u),
            (this.r = t || this.r || (this.is(zt) ? Ut : qt)),
            (this.t = n || this.t),
            w(an({}, Yt, this.t, { Transition: this.r }), function (n, t) {
              n = n(i, u, i.n);
              (u[t] = n).setup && n.setup();
            }),
            w(u, function (n) {
        ...
        (n.emit = function (n) {
          var t;
          return (
            (t = this.event).emit.apply(t, [n].concat(u(arguments, 1))), this
          );
        }),
        (n.add = function (n, t) {
        ...
        (n.destroy = function (t) {
          ...
          return (
            i.is(1)
              ? K(this).on("ready", this.destroy.bind(this, t))
              : (w(
                  this.i,
                  function (n) {
    ...
    return (t.defaults = {}), (t.STATES = i), t;
  }),
  "object" == typeof exports && "undefined" != typeof module
    ? (module.exports = t())
    : "function" == typeof define && define.amd
...
(t = function () {
  ...
  function W() {
    ...
    return {
      bind: function (t, n, o, u) {
        e(t, n, function (t, n, e) {
          var i = "addEventListener" in t,
            r = i
              ? t.removeEventListener.bind(t, n, o, u)
              : t.removeListener.bind(t, o);
          i ? t.addEventListener(n, o, u) : t.addListener(o),
            s.push([t, n, e, o, r]);
        });
      },
      ...
      dispatch: function (t, n, e) {
        ...
        return (
          "function" == typeof CustomEvent
            ? (i = new CustomEvent(n, { bubbles: !0, detail: e }))
  ...
  function H(t, n) {
    return (
      t instanceof HTMLElement && (t.msMatchesSelector || t.matches).call(t, n)
    );
  }
  function J(t, n) {
    return n
  ...
  function p(t, n, e) {
    if (t)
      for (var i = X(t), i = e ? i.reverse() : i, r = 0; r < i.length; r++) {
        var o = i[r];
  ...
  function $(i) {
    return (
      c(arguments, 1).forEach(function (e) {
        p(e, function (t, n) {
          i[n] = e[n];
        });
      }),
  ...
  function G(e) {
    return (
      c(arguments, 1).forEach(function (t) {
        p(t, function (t, n) {
          Q(t)
            ? (e[n] = t.slice())
            : h(t)
  ...
  var rt = "splide__video",
    m = "--has-video",
    ot = { hideControls: !1, loop: !1, mute: !1, volume: 0.2 },
    ut = "video:click",
    st = (function () {
      function t(t, n, e) {
        (this.state = Y(1)),
    ...
    ct = (function (i) {
      function t(t, n, e) {
        return (
          (t =
            i.call(this, t, n, (e = void 0 === e ? {} : e)) || this).state.set(
            3,
          ),
          t
        );
      ...
      return (
        (n.createPlayer = function (t) {
          ...
          return (
            ...
            i("play", this.onPlay),
            i("pause", this.onPause),
            i("ended", this.onEnded),
            i("loadeddata", this.onPlayerReady),
            i("error", this.onError),
            t
          );
        }),
  ...
  function lt(t) {
    ...
    if (((n = t), !isNaN(parseFloat(n)) && isFinite(n) && Math.floor(n) == n))
  ...
  function T() {
    ...
    if ((E(this, "_id", "_WeakMap_" + pt() + "." + pt()), 0 < arguments.length))
      throw new TypeError("WeakMap iterable is not supported");
  }
  function P(t, n) {
    if (!F(t) || !dt.call(t, "_id"))
      throw new TypeError(
  ...
  (k =
    ...
    (k.WeakMap =
      ((E = function (t, n, e) {
        ...
        return (
          P(this, "delete"),
          !!F(t) && !(!(n = t[this.t]) || n[0] !== t) && (delete t[this.t], !0)
        );
      }),
      E(T.prototype, "get", function (t) {
        var n;
        return (
          P(this, "get"), F(t) && (n = t[this.t]) && n[0] === t ? n[1] : void 0
        );
      }),
      ...
      E(T.prototype, "set", function (t, n) {
        ...
        if ((P(this, "set"), F(t)))
          return (
            (e = t[this.t]) && e[0] === t ? (e[1] = n) : E(t, this.t, [t, n]),
            this
          );
    ...
    (i = function () {
      ...
      function a(t) {
        ...
        return (
          "function" ==
            typeof (n =
              null == t || ("object" != e && "function" != e) ? n : t.then) && n
        );
      }
      function f() {
        for (var t = 0; t < this.chain.length; t++) {
          ...
          try {
            !1 === r
              ? o.reject(i.msg)
              : (n = !0 === r ? i.msg : r.call(void 0, i.msg)) === o.promise
                ? o.reject(TypeError("Promise-chain cycle"))
                : (e = a(n))
                  ? e.call(n, o.resolve, o.reject)
                  : o.resolve(n);
          } catch (t) {
            o.reject(t);
          }
      ...
      return (
        ...
        n(p, "resolve", function (e) {
          return e && "object" == typeof e && 1 === e.n
            ? e
  ...
  function x(t, n, e) {
    ...
    return (
      !i[n] ||
      (e
        ? (-1 !== (e = i[n].indexOf(e)) && i[n].splice(e, 1),
          C.set(t.element, i),
          i[n] && 0 === i[n].length)
        : ((i[n] = []), C.set(t.element, i), !0))
    );
  }
  function wt(t) {
    if ("string" == typeof t)
  ...
  function mt(e, i) {
    ...
    (i = wt(i)).event
      ? ("error" === i.event &&
          M(e, i.data.method).forEach(function (t) {
            var n = new Error(i.data.message);
            (n.name = i.data.name), t.reject(n), x(e, i.data.method, t);
          }),
        (u = M(e, "event:".concat(i.event))),
        (n = i.data))
      : i.method &&
        ((t = e),
        (r = i.method),
        (r = !((o = M(t, r)).length < 1) && (x(t, r, (t = o.shift())), t)) &&
          (u.push(r), (n = i.value))),
  ...
  function gt(t, n) {
    ...
    if (n)
      return (
        null === n.getAttribute("data-vimeo-initialized") &&
  ...
  function Et(o, t, n) {
    ...
    return new Promise(function (n, e) {
      ...
      for (t in u)
        u.hasOwnProperty(t) &&
          (i += "&".concat(t, "=").concat(encodeURIComponent(u[t])));
      var r = new (
        "XDomainRequest" in window ? XDomainRequest : XMLHttpRequest
      )();
      r.open("GET", i, !0),
        (r.onload = function () {
          if (404 === r.status) e(new Error("“".concat(o, "” was not found.")));
  ...
  function Tt(t) {
    ...
    t.forEach(function (n) {
      try {
        var t;
        null === n.getAttribute("data-vimeo-defer") &&
          Et(lt((t = kt(n))), t, n)
            .then(function (t) {
              return gt(t, n);
            })
    ...
    window.VimeoSeoMetadataAppended ||
      ...
      window.addEventListener("message", function (t) {
        if (b(t.origin)) {
          ...
          if (n && "ready" === n.event)
            for (
              var e, i = s.querySelectorAll("iframe"), r = 0;
              r < i.length;
              r++
            ) {
              var o = i[r],
              ...
              (e = o.src),
                /^https:\/\/player\.vimeo\.com\/video\/\d+/.test(e) &&
                  u &&
                  new Ct(o).callMethod(
                    "appendVideoMetadata",
  ...
  var R,
    ...
    Ct = (function () {
      function r(o) {
        ...
        if (
          ("IFRAME" === o.nodeName ||
            ((e = o.querySelector("iframe")) && (o = e)),
          "IFRAME" === o.nodeName && !b(o.getAttribute("src") || ""))
        )
          throw new Error("The player element passed isn’t a Vimeo embed.");
        if (O.has(o)) return O.get(o);
        (this.e = o.ownerDocument.defaultView),
          (this.element = o),
          (this.origin = "*");
        var i,
          t = new _(function (i, r) {
            ...
            (u.i = function (t) {
              var n, e;
              b(t.origin) &&
                u.element.contentWindow === t.source &&
                ("*" === u.origin && (u.origin = t.origin),
                (t = wt(t.data)) &&
                "error" === t.event &&
                t.data &&
                "ready" === t.data.method
                  ? (((n = new Error(t.data.message)).name = t.data.name), r(n))
                  : ((n = t && "ready" === t.event),
                    (e = t && "ping" === t.method),
                    n || e
                      ? (u.element.setAttribute("data-ready", "true"), i())
                      : mt(u, t)));
            }),
              u.e.addEventListener("message", u.i),
        ...
        return (
          ...
          S.isEnabled &&
            ...
            (this.fullscreenchangeHandler = function () {
              (S.isFullscreen ? j : x)(u, "event:exitFullscreen", i),
                u.ready().then(function () {
                  I(u, "fullscreenchange", S.isFullscreen);
                });
            }),
            S.on("fullscreenchange", this.fullscreenchangeHandler)),
          this
        );
      }
      var t, n, e;
        ...
        (n = [
            ...
            value: function (e) {
              ...
              return new _(function (t, n) {
                return i
                  .ready()
                  .then(function () {
                    j(i, e, { resolve: t, reject: n }), I(i, e, r);
                  })
                  .catch(n);
              });
            },
              ...
              return new _(function (t, n) {
                return (
                  ...
                  i
                    .ready()
                    .then(function () {
                      j(i, e, { resolve: t, reject: n }), I(i, e);
                    })
                    .catch(n)
                );
              });
          ...
          },
          {
            ...
            value: function (e, i) {
              var r = this;
              return new _(function (t, n) {
                if (((e = ht(e, "set")), null == i))
                  throw new TypeError("There must be a value to set.");
                return r
                  .ready()
                  .then(function () {
                    j(r, e, { resolve: t, reject: n }), I(r, e, i);
                  })
                  .catch(n);
              });
            },
          },
          {
            ...
            value: function (t, n) {
              ...
              0 === M(this, "event:".concat(t)).length &&
                this.callMethod("addEventListener", t).catch(function () {}),
                j(this, "event:".concat(t), n);
            },
          },
          {
            key: "off",
            value: function (t, n) {
              ...
              if (n && "function" != typeof n)
                throw new TypeError("The callback must be a function.");
              x(this, "event:".concat(t), n) &&
                this.callMethod("removeEventListener", t).catch(
                  function (t) {},
                );
            },
          },
                ...
                _t.delete(e),
                  ...
                  e.element &&
                    ...
                    (n = e.element.querySelector("iframe")) &&
                      n.parentNode &&
                      (n.parentNode.parentNode && e.r && e.r !== n.parentNode
                        ? n.parentNode.parentNode.removeChild(n.parentNode)
                        : n.parentNode.removeChild(n))),
                  e.e.removeEventListener("message", e.i),
                  S.isEnabled &&
                    S.off("fullscreenchange", e.fullscreenchangeHandler),
                  t();
              });
            },
          },
      ...
      (ft ||
        ...
        (A = {
          request: function (r) {
            return new Promise(function (t, n) {
              ...
              var i = (r = r || document.documentElement)[
                R.requestFullscreen
              ]();
            ...
            return new Promise(function (n, t) {
              ...
              A.isFullscreen
                ? (A.on(
                  ...
                  (i = document[R.exitFullscreen]()) instanceof Promise &&
                    i.then(e).catch(t))
                : n();
            });
          },
        ...
        (function (t) {
          ...
          window.VimeoPlayerResizeEmbeds_ ||
            ...
            window.addEventListener("message", function (t) {
              if (b(t.origin) && t.data && "spacechange" === t.data.event)
                for (
                  var n = i.querySelectorAll("iframe"), e = 0;
                  e < n.length;
                  e++
                )
                  if (n[e].contentWindow === t.source) {
                    n[e].parentElement.style.paddingBottom = "".concat(
          ...
          (n.createPlayer = function (t) {
            var n = this.options,
              ...
              t = new Ct(
                ...
                $(
                  t,
                  { controls: !n.hideControls, loop: n.loop, muted: n.mute },
                  e.vimeo || {},
                ),
              );
            return (
              t.on("play", this.onPlay),
              t.on("pause", this.onPause),
              t.on("ended", this.onEnded),
              t.ready().then(this.onPlayerReady, this.onError),
              t.getMuted() || t.setVolume(it(n.volume, 0, 1)),
              t
            );
          }),
          (n.playVideo = function () {
      ...
      return (
        (n.load = function (t) {
          ...
          this.attachCallback(t),
            this.shouldLoad() &&
              w("script", { src: location.protocol + jt }, document.head);
        }),
        (n.shouldLoad = function () {
          return (
            (t = document),
            !((n = "script") ? c(t.querySelectorAll(n)) : []).some(
              function (t) {
        ...
        (n.attachCallback = function (t) {
          var n;
          D(window.onYouTubeIframeAPIReady) ||
    ...
    g = (function (i) {
      function t(t, n, e) {
        return (
          ((t =
            i.call(this, t, n, (e = void 0 === e ? {} : e)) || this).videoId =
            t.parseVideoId(n)),
          t.videoId &&
            (t.state.set(2), new Mt().load(t.onAPIReady.bind(St(t)))),
          t
        );
      }
      qt(t, i);
      ...
      return (
        ...
        (n.onPlayerReady = function () {
          i.prototype.onPlayerReady.call(this),
            this.player.setVolume(100 * it(this.options.volume, 0, 1));
        }),
    ...
    It = (function () {
      ...
      return (
        ...
        (n.create = function () {
          (this.video = w("div", rt, this.parent)),
            (this.playButton = w(
              "button",
              {
            ...
            (this.wrapper = w("div", "splide__video__wrapper", this.video)),
            (this.placeholder = w("div", null, this.wrapper));
        }),
        (n.listen = function () {
          var t = this;
        ...
        (n.destroy = function () {
          tt(this.slide, s + m),
            tt(this.container, e + m),
            d(this.video, function (t) {
    ...
    Rt = [
      ["data-splide-youtube", g],
      ["data-splide-vimeo", k],
      ["data-splide-html-video", ct],
    ],
    At = (function () {
      function t(t, n) {
        (this.Splide = t),
          (this.slide = n),
          (this.event = u(t)),
          (this.options = G(G({}, ot), this.Splide.options.video)),
          this.createPlayer(n),
      ...
      return (
        ...
        (n.listen = function () {
          ...
          this.ui.on("click", this.onClick.bind(this)),
            ...
            n.on("error", this.onError.bind(this)),
            e.on(["move", "scroll"], this.pause.bind(this)),
            e.on(ut, this.onVideoClick.bind(this)),
            e.on("drag", function () {
              e.off(i),
                e.on(i, function () {
                  t.pause(), e.off(i);
            ...
            this.options.autoplay &&
              e.on(
                ["mounted", "moved", "scrolled"],
                this.onAutoplayRequested.bind(this),
              );
        }),
        (n.onClick = function () {
          this.isPaused() ? this.play() : this.pause(),
            this.event.emit(ut, this);
        }),
        ...
        (n.onPlayed = function () {
          this.ui.hide(),
            ...
            this.event.emit("video:play", this);
        }),
        (n.onPause = function () {
          this.ui.show();
        }),
        ...
        (n.onError = function () {
          y(this.slide, "is-error"),
            this.ui.show(),
            this.event.emit("video:error", this);
        }),
        (n.onAutoplayRequested = function () {
          this.Splide.Components.Slides.getAt(this.Splide.index).slide ===
            this.slide && this.play();
        }),
    ...
    function i() {
      e.forEach(function (t) {
        var n,
          ...
          i = t.slide;
        (e = s + m),
          ((n = i) && n.classList.contains(e)) || (o[t.index] = new At(r, i));
      }),
        e.update();
    }
    return {
  ...
  "undefined" != typeof window &&
    ...
    (window.splide.Extensions.Video = Ot));
}),
    ...
    function i(c, r, s) {
      f(c, r, function (a, u, l) {
        n = n.filter(function (d) {
          return d[0] === a && d[1] === u && d[2] === l && (!s || d[3] === s)
            ? (d[4](), !1)
            : !0;
        });
      });
...
!(function () {
  ...
  (n.prototype.TYPES = [
    ...
    (n.prototype.scan = function (t) {
      for (
        var e, n, r, i = t.querySelectorAll(this.TYPES.join(",")), a = 0;
        a < i.length;
        a++
      )
        (n = (0, this[(e = i[a]).tagName.toLowerCase() + "ToPath"])(
    ...
    (i.prototype.mapping = function () {
      ...
      for (
        s = a = o = 0, e = this.el.querySelectorAll("path"), l = !1, t = 0;
        t < e.length;
        t++
      )
      ...
      if ($("#search-form, #search-form-modal").length > 0) {
        ...
        if (!initSearchResult) {
          ...
          var recentSearches = JSON.parse(
            localStorage.getItem("petronas_recent_searches"),
          );

          const searchClient = algoliasearch(
            "IK2A979H8U",
            "b744df046e750c5d48467cebf1fa0adc",
          );
          ...
          function setInstantSearchUiState(indexUiState) {
            ...
            if (typeof indexUiState.submittedFilter !== "undefined") {
              if (
                typeof indexUiState.submittedFilter.refinementList !==
                "undefined"
              ) {
                refinementListArray =
                  indexUiState.submittedFilter.refinementList;
              }
          ...
          $.fn.onFilterFormSubmit = function (data) {
            ...
            if (selectedTopics.length > 0) {
              currentUiState.submittedFilter.refinementList.topic_name =
                selectedTopics;
            }

            let publishedStart =
              $("#edit-published-start").datepicker("getDate") !== null
                ? $("#edit-published-start").datepicker("getDate").getTime() /
                  1000
                : null;
            let publishedEnd =
              $("#edit-published-end").datepicker("getDate") !== null
                ? $("#edit-published-end").datepicker("getDate").getTime() /
                    1000 +
                  86400
                : null;

            if (publishedStart !== null && publishedEnd !== null) {
              currentUiState.submittedFilter.range.created =
            ...
            if (
              Object.keys(currentUiState.submittedFilter.range).length > 0 ||
              Object.keys(currentUiState.submittedFilter.refinementList)
                .length > 0
            ) {
                  ...
                  templates: {
                    item({ item, components, html }) {
                      if (item.thumbnail == "") {
                        item.thumbnail =
                          drupalSettings.path.baseUrl +
                          "/themes/custom/matrix/images/search-placeholder.png";
                      }
                ...
                html`<div class="aa-PanelLayout aa-Panel--scrollable">
                  <div class="row">
                    <div class="col-md-4 col-lg-5 mb-4 mb-md-0">
                      <div class="aa-section-title text-primary mb-2">
            ...
            search.addWidgets([
                ...
                templates: {
                  text(data, { html }) {
                    ...
                    return html`<div class="content">
                      ${prefixLabel} <strong>${count}</strong> ${spacerText}
                      <span class="search-keyword">${data.query}</span>
                    </div>`;
                  },
                },
              }),
              ...
              instantsearch.widgets.sortBy({
                ...
                items: [
                  ...
                  {
                    label: Drupal.t("Latest Date"),
                    value: indexName + "_created_desc",
                  },
                ],
              }),
                              ...
                              (breadcrumbItem) =>
                                html`${breadcrumbItem.url === ""
                                  ? html`<a href="${hit.url}"
                                    ...
                                    >`
                                  : html`<a href="${breadcrumbItem.url}"
                                      >${breadcrumbItem.title}</a
                                    >`} `,
                            )}
                          </div>
              ...
              if ($("#st-loading-indicator").length > 0) {
                ...
                if (
                  ...
                  if (
                    search.status == "idle" &&
                    $(".ais-Hits").length > 0 &&
                    !$(".ais-Hits").hasClass("ais-Hits--empty") &&
                    ...
                    if (
                      recentSearches.includes(search.helper.state.query) ==
                      false
                    ) {
                      recentSearches.unshift(search.helper.state.query);
                      recentSearches.splice(5);
                      localStorage.setItem(
                        "petronas_recent_searches",
                        JSON.stringify(recentSearches),
                      );

                      if (
                        $("#search-recent").find(".popular-item").length >= 5
                      ) {
                        $("#search-recent")
                          .find(".popular-item")
                          .slice(-1)
                      ...
                      $.each(recentSearches.slice(0, 1), function () {
                        $("#search-recent .items").prepend(
                          '<div class="popular-item d-flex align-items-center"><span>' +
                            this +
                            '</span> <a href=""></a></div>',
                        );
                      });
          ...
          $(once("algoliaFilterClick", "#filter-widget, .filters-close")).on(
            "click",
            function (e) {
          ...
          $.ajax({
            ...
            success: function (result) {
              ...
              $.each(popularTags, function () {
                $("#search-form-popular .items").append(
                  '<div class="popular-item d-inline-flex d-md-flex align-items-center"><span>' +
                    this.name +
                    '</span> <a href=""></a></div>',
                );
              });

              $("#search-form-popular").on(
                "click",
                ".popular-item a",
                function (e) {
                  result.results.push({
          ...
          $("#search-recent").on("click", ".popular-item span", function () {
            ...
            search.helper.setQuery($(this).text()).search();
            //window.location = searchPageUrl + $(this).text();
          });

          $("#search-recent").on("click", ".popular-item a", function (e) {
            let recentIndex = recentSearches.indexOf(
            ...
            if (typeof recentIndex !== "undefined") {
              ...
              $("#search-recent")
                .find(".popular-item")
                .slice(recentIndex, recentIndex + 1)
                .remove();
              localStorage.setItem(
                "petronas_recent_searches",
                JSON.stringify(recentSearches),
...
(function ($, Drupal, cookies) {
  ...
  $(".paragraph").each((index, para) => {
    ...
    $(para)
      ...
      .each((pindex, item) => {
        ...
        if (
          /(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com))/.test(videoUrl)
        ) {
          $(item).attr("data-fancybox", "").removeAttr("target");
        }
      });
    //}
  });
  ...
  if ($(".view-display-id-block_media_listing").length > 0) {
    ...
    var moveFormItems = function () {
      if (window.matchMedia("(max-width: 767px)").matches) {
        $(
          ".views-exposed-form > div > .js-form-item:not(.form-item-search-container)",
        ).each(function () {
      ...
      if (window.matchMedia("(min-width: 768px)").matches) {
        $(
          ".views-exposed-form .form-item-search-container > .js-form-item:not(.form-item-keywords)",
        ).each(function () {
          console.log($(this).attr("class"));
  ...
  if ($(".block-modal").length > 0) {
    $(".block-modal").each(function () {
      if (
        $(this).data("show-once") == "0" ||
        ($(this).data("show-once") == "1" &&
          cookies.get("modal-" + $(this).attr("id")) !== "1")
      ) {
  ...
  //     if ($('.block-sticky-modal').length > 0) {
  //       if ($('.block-sticky-modal').data('show-once') == '0' || ($('.block-sticky-modal').data('show-once') == '1' && cookies.get('modal-' + $('.block-sticky-modal').attr('id')) !== '1')) {
  //         // Add a class to transition the popup into view
  ...
  //         // Remove the class to slide the popup back down
  ...
  $(".block-sticky-modal .btn-sticky-close").on("click", function (e) {
    ...
    // Show the popup again after 2 minutes
    setTimeout(function () {
      modalClosed = false;
      showPopup();
  ...
  $(".block-sticky-modal a").on("click", function (e) {
    ...
    cookies.set("modal-" + $(".block-sticky-modal").attr("id"), 1, {
      expires: 365,
    }); // Set a long expiration (e.g., 365 days)
  ...
  function changeSelectOptionBasedOnURL() {
    ...
    if (window.location.href.includes("/bm/")) {
      ...
      var select = document.querySelector(
        'select[data-drupal-selector="edit-field-content-language-value"]',
      );
...
(function ($, Drupal) {
  ...
  $(function () {
    if ($(".paragraph--type--section-content-slider").length > 0) {
      var elms = document.querySelectorAll(
        ".paragraph--type--section-content-slider .splide",
      );
      ...
      for (var i = 0; i < elms.length; i++) {
        ...
        splieName = new Splide(elms[i], {
          type: "loop",
          arrows:
            $(elms[i]).eq(0).find(".splide__slide").length > 1 ? true : false,
          pagination:
            $(elms[i]).eq(0).find(".splide__slide").length > 1 ? true : false,
          drag:
            $(elms[i]).eq(0).find(".splide__slide").length > 1 ? true : false,
        ...
        splieName.on("mounted", function () {
          ...
          var bgNext = $(
            getId +
              ".splide .splide__track .splide__list .splide__slide:first-child",
          )
            .next()
            .children(".JindexRow5Slide")
            .children(".JindexRow5SlideLeft")
            .children(".JindexRow5SlideLeftInner")
            .children(".JindexRow5SlideLeftImg")
          ...
          ).css("background-image", "url(" + bgNext + ")");
          ...
          splieName.on("moved", function () {
            if (
              $(
                getId +
                  ".splide .splide__track .splide__list .splide__slide.is-active",
              ).next().length == 0
            ) {
              bgNext = $(
                getId +
  ...
  if ($(".paragraph--type--section-content-slider-2").length > 0) {
    $(".paragraph--type--section-content-slider-2 .splide").each(
      (i, carousel) => {
        new Splide(carousel, {
          type: "loop",
          arrows: $(carousel).find(".splide__slide").length > 1 ? true : false,
          pagination:
            $(carousel).find(".splide__slide").length > 1 ? true : false,
  ...
  if ($(".paragraph--type--section-video-gallery").length > 0) {
    var sliderG3 = new Splide(
      ".paragraph--type--section-video-gallery .JmasterRow6ContentSlideD .splide",
      {
        type: "loop",
      },
    );
    ...
    var sliderG3m = new Splide(
      ".paragraph--type--section-video-gallery .JmasterRow6ContentSlideM .splide",
      {
        type: "loop",
        isNavigation: true,
        perPage: 3,
  ...
  if ($(".paragraph--type--section-financial-highlight").length > 0) {
    $(".paragraph--type--section-financial-highlight").each(
      (item, carousel) => {
        ...
        sliderG5.on("move", function (newIndex, oldIndex, destIndex) {
          newIndex += 1;
          var _height = $(
            "#" + sliderG5Pid + "-slide0" + newIndex + " > div",
          ).outerHeight();
          $(carousel).find(".splide__list").height(_height);
        });
  ...
  if ($(".paragraph--type--section-content-slider-3").length > 0) {
    $(".paragraph--type--section-content-slider-3 .splide").each(
      (i, carousel) => {
        new Splide(carousel, {
          type: "loop",
          arrows: $(carousel).find(".splide__slide").length > 1 ? true : false,
  ...
  $(".JmasterRow6LeftYT a").click(function () {
    $(this).hide();
    $(".JmasterRow6LeftYT > iframe")[0].contentWindow.postMessage(
  ...
  if (
    $(".JmasterRow6Container .JmasterRow6RightContainer ul li a").length > 0
  ) {
    var data_ytid = getYoutubeId(
      $(
        ".JmasterRow6Container .JmasterRow6RightContainer ul:first-child li:first-child a:first-child",
      ).data("yt"),
    );
    var tempTYurl =
      "https://www.youtube.com/embed/" +
      data_ytid +
      "?enablejsapi=1&version=3&playerapiid=ytplayer&mute=0&modestbranding=1&controls=0";
    $(".JmasterRow6LeftYT iframe").attr("src", tempTYurl);
  }

  $(
    ".JmasterRow6Container .JmasterRow6RightContainer ul li a, .JmasterRow6Container .JmasterRow6ContentSlideM a",
  ).on("click", function () {
    ...
    $(".JmasterRow6LeftYT a").css(
      "background-image",
      "url(" + $(this).data("yt-img") + ")",
    );
    $(".JmasterRow6LeftYT iframe").attr("src", tempTYurl);
  });
  ...
  Drupal.behaviors.petronas = {
    attach: function (context, settings) {
      ...
      $(".paragraph img")
        ...
        .each((i, item) => {
          if (
            typeof $(item).attr("data-entity-type") !== "undefined" &&
            $(item).attr("data-entity-type") !== ""
          ) {
...
(function ($, Drupal) {
  Drupal.behaviors.petronasParagraphPortfolioLinks = {
    attach: function (context, settings) {
      $(".paragraph--type--inner-portfolio-links", context)
        .once("innerPortfolioLinksOnLoad")
        .each(function (index) {
          const carousels = this.querySelectorAll(".splide");
          carousels.forEach((carouselEl, i) => {
            const rtl = i % 2 === 1;
          ...
          $(document)
            .once("docCloseOverlay")
            .on("click", function (event) {
              if (
                $(event.target).closest(".JgeneralPopupContainer").length > 0
              ) {
                $("body").removeClass("noScroll");
                $(".JgeneralPopupContainer").fadeOut();
              }
            });
        });
    },
...
(function ($, Drupal) {
  Drupal.behaviors.petronasParagraphSpotlights = {
    attach: function (context, settings) {
      $(".paragraph--type--inner-spotlights")
        .once("initSpotlightPara")
        .each(function () {
          let $spotlightPara = $(this);
          $spotlightPara.find(".accordion-button").on("click", function (e) {
            $spotlightPara
              .find(".image")
              .css(
                "background-image",
                'url("' + $(e.target).attr("data-image") + '")',
              );

            $spotlightPara.find(".accordion-item").each(function () {
              $(this)
...
(function ($, Drupal) {
  Drupal.behaviors.petronasParagraphMultiColContentV2 = {
    attach: function (context, settings) {
      $(".column-item-content", context)
        .once("initMulColContentHeight")
        .each(function () {
            ...
            if (mediaQuery.matches) {
              ...
              if (containerHeight > 0) {
                const imagePercentage =
                  ((containerHeight - contentHeight) / containerHeight) * 100;
                $image.css("height", imagePercentage + 8 + "%");
              }
            } else {
              $image.css("height", "");
            }
          ...
          $(window).on("resize.adjustImageHeight", adjust);
        });
    },
  };
})(jQuery, Drupal);
(function ($, Drupal) {
  Drupal.behaviors.petronasParagraphMediaFrontpage = {
    attach: function (context, settings) {
      $(".paragraph--type--media-frontpage", context)
        .once("innerMediaFrontpageOnLoad")
        .each(function () {
          const $para = $(this);
          const $listing = $(".paragraph--type--media-frontpage .owl-carousel");
          const $itemCount =
            $('.paragraph--type--media-frontpage [data-featured-wide="1"]')
              .length > 0
              ? 1
              : 2;
          $listing.owlCarousel({
            ...
            onInitialized: function (event) {
              ...
              if (!$carousel.find(".owl-controls-wrapper").length) {
                const $wrapper = $(
                  '<div class="owl-controls-wrapper position-relative mt-3"></div>',
                );
                $nav.add($dots).wrapAll($wrapper);

                const $controlsWrapper = $carousel.find(
                  ".owl-controls-wrapper",
                );
                $controlsWrapper.append(
                  '<div class="carousel-footer-links news-link-wrapper d-none d-md-block">\
                <a href="/media/media-releases" class="news-link link-read-more smaller animate-icon">\
                    <i></i>\
                    <p>' +
                    Drupal.t("View all") +
                    "</p>\
...
(function ($, Drupal) {
  Drupal.behaviors.petronasParagraphBannerCarousel = {
    attach: function (context, settings) {
      $(".paragraph--type--inner-banner-carousel", context)
        .once("innerBannerCarouselOnLoad")
        .each(function () {
          const autoplayTimeout = 8000;
          const $bannerImageCarousel = $(this);
          const $carousel = $bannerImageCarousel.find(".banner-carousel-items");
          ...
          const $navItems = $(".banner-carousel-nav > div", context);

          // Inject text-clip progress markup
          $navItems.each(function () {
            const label = $(this).text().trim();
            $(this).html(`
              <div class="progress-nav-item">
                <div class="progress-text-wrapper">
                  <span class="base-text">${label}</span>
                  <span class="clip-progress">${label}</span>
                </div>
          ...
          function resetProgress() {
            $navItems.find(".progress-bar").css({
              width: "0%",
              transition: "none",
            });
            $navItems.find(".clip-progress").css({
              width: "0%",
              transition: "none",
            });
          }
          ...
          function animateProgress(index) {
            const $bar = $navItems.eq(index).find(".progress-bar");
            const $clip = $navItems.eq(index).find(".clip-progress");
            ...
            // Text clip
            $clip.css({ transition: "none", width: "0%" });
            void $clip[0].offsetWidth;
            $clip.css({
              transition: `width ${autoplayTimeout}ms linear`,
              width: "100%",
            });
          ...
          $carousel.on("changed.owl.carousel", function (e) {
            ...
            $navItems.removeClass("active").eq(current).addClass("active");
          });

          // Pause/resume on hover
          $bannerImageCarousel.on("mouseover", function () {
            $navItems
              .find(".progress-bar, .clip-progress")
              .css("transition-play-state", "paused");
          });
          $bannerImageCarousel.on("mouseleave", function () {
            $navItems
              .find(".progress-bar, .clip-progress")
              .css("transition-play-state", "running");
          });
        });
    },
  };
