...
(window.SocialService = new socialService()),
  ...
  (function (n, t) {
    ...
    function n(n, t) {
      if (n && t) {
        const i = n.closest(".modal");
        i &&
          i.addEventListener("shown.bs.modal", () => {
            t.refresh();
          });
      }
    }
    return { refreshSplideOnDialogShown: n };
  }),
  (function (n, t) {
    n.OpenDialog = t;
  })(window, function (n) {
    const i = document,
      ...
      r = i.getElementById("main-wrapper");
    t.addEventListener("show.bs.modal", () => {
      i.querySelectorAll(".dialog-module.show").forEach((n) => {
    ...
    t.addEventListener("hide.bs.modal", () => {
      try {
            ...
            t.json().then((t) => {
              ...
              if (r !== "") {
                ...
                if (n) {
                  ...
                  t.setAttribute("href", encodeURI(n.link));
...
(function (n, t, i) {
    ...
    function b(n, t) {
      if ("URLSearchParams" in window) {
        const o = {},
          i = new URLSearchParams(window.location.search);
        i.set("page", t);
        const e = window.location.pathname + "?" + i.toString();
        c(window.location.href, e);
        w(window.location.origin + e);
    ...
    function y(n, t) {
      ...
      if (f > o) {
        ...
        i.querySelectorAll(".page-link").forEach((t) => {
          const r = t.getAttribute("data-cvx-page");
          t.setAttribute("href", `archive?page=${encodeURIComponent(r)}`);
        ...
        i.articles.forEach((t) => {
          ...
          t.isexternalarticle
            ? ((i.querySelector(".secondary-link").target = "_blank"),
              t.newssource !== null && t.newssource !== ""
                ? (i.querySelector(".category").innerHTML = t.newssource)
          ...
          t.image.src !== null &&
            t.image.src !== "" &&
            (i.querySelector(".image-container").style.backgroundImage =
              `url('${t.image.src}')`);
          r.appendChild(i);
        });
        t.appendChild(r);
  ...
  (function (n, t) {
    const i = "a13Cookie",
      e = "#onetrust-banner-sdk",
      o = ".a13",
      r = 1e4,
      u = () => n.cookie && n.cookie.indexOf(i) >= 0,
      s = function () {
        const t = new Date();
      ...
      f = function () {
        const n = t(e);
        n.length && n.is(":visible") ? setTimeout(f, r) : h();
      },
      h = function () {
        t(o).each(function () {
          const n = t(this);
  ...
  (function (n, t) {
    ...
    n.addEventListener("DOMContentLoaded", function () {
      n.querySelectorAll(".c01r").forEach((n) => {
        function f(n, t = 300) {
          let i;
          return (...r) => {
            clearTimeout(i),
          ...
          i(".c41").each(function () {
            function a() {
              s = setInterval(function () {
                n.textContent = u.slice(0, o + 1);
                f.textContent = u.slice(o + 1, u.length);
                o++;
                o > u.length && (clearInterval(s), h());
              }, c);
            }
            function h() {
              n.classList.remove("transparent");
              n.classList.add("opaque");
              r.find(".stop-animation").hide();
              r.addClass("animation-paused");
              clearInterval(s);
            }
            const r = i(this),
              e = r.find(".quote-text");
            ...
            r.find(".stop-animation").on("click", function () {
              h();
            });
            l();
            const v = function (n) {
              const t = new IntersectionObserver(
                function (i) {
                  i.forEach((i) => {
                    i.isIntersecting && (a(), t.unobserve(n));
                  });
                },
  ...
  (function (n, t) {
    const i = function (n) {
        const t = n.querySelector(".sequence"),
          i = "start-animation";
    ...
    t.addEventListener("DOMContentLoaded", function () {
      t.querySelectorAll(".c48r .animation").forEach((i) => {
        const u = i.dataset.format.trim(),
          e = i.dataset.sequenceValues.split("|"),
          c = i.querySelector(".prefix"),
          o = i.querySelector(".postfix"),
          f = i.querySelector(".sequence");
        f.closest(".sequence-window").style.setProperty(
          "height",
          n.getComputedStyle(f).lineHeight,
        );
        const s = e.length,
          h = "{x}";
        if (u && u.includes(h)) {
        ...
        if (e) {
          if (s > 0) {
            const n = parseFloat((100 - 100 / s).toFixed(2));
            f.style.setProperty("--roll-distance", `-${n}%`);
          }
          e.forEach((n) => {
            let i = t.createElement("div");
            i.innerHTML = n;
...
(window.PDFREPORT === null || window.PDFREPORT === undefined) &&
  ...
  (function (n, t) {
    ...
    const r = window.location.search.indexOf("sc_mode=preview");
    t(".modal-body-content").each(function () {
      ...
      let s = t(this).hasClass("video-modal-style"),
        f;
      u && u !== null && (f = u.indexOf(n.split("_")[1].toUpperCase()));
      const h = "'" + n + "'";
      if (r > -1 && f > -1) {
        let i =
  ...
  (function (n) {
    function t(n) {
      return n.reduce((n, t) => (t.length > n.length ? t : n));
    }
    function i(i, r, u) {
      const e = i
        .querySelector(".digit-template")
        .content.firstElementChild.cloneNode(!0);
      u.innerHTML = "";
      const o = r.dataset.cvxFormatString.trim().split("{#}"),
        f = r.dataset.cvxSequence.split("|");
      if (o && f) {
        const s = o[0],
          h = o[1];
        if (s) {
          const t = n.createElement("span");
          t.classList.add("prefix", "inline-item");
          t.innerHTML = s;
          r.prepend(t);
        }
        if (h) {
          const t = n.createElement("span");
          t.classList.add("suffix", "inline-item");
          t.innerHTML = h;
          r.append(t);
        }
        const c = f.length,
          l = t(f);
        e.querySelector(".value").innerHTML = l;
        f.forEach((t) => {
          const i = n.createElement("span");
          i.innerHTML = t;
          e.querySelector(".slide").append(i);
        });
        const a = parseFloat((100 - 100 / c).toFixed(2));
        u.style.setProperty("--roll-distance", `-${a}%`);
        u.appendChild(e);
        u.classList.add("show");
      }
    }
    function r(n) {
      const t = n.querySelector(".data-point"),
        r = n.querySelector(".digit-container");
      if (t && r) {
        i(n, t, r);
        let u = new IntersectionObserver(
          (n) => {
            n.forEach((n) => {
              n.isIntersecting === !0 && r.classList.add("animate");
            });
          },
    ...
    n.addEventListener("DOMContentLoaded", function () {
      n.querySelectorAll(".c11b-5").forEach((n) => {
        r(n);
      });
    });
  })(document),
  ...
  (function (n, t) {
    ...
    n.addEventListener("DOMContentLoaded", function () {
      n.querySelectorAll(".c57").forEach((n) => {
        ...
        t.mount();
        DialogNamespace.refreshSplideOnDialogShown(i, t);
        t.on("move", () => {
          if (t.index >= 1 && !r) {
  ...
  (function (n) {
    n.addEventListener("DOMContentLoaded", function () {
      n.querySelectorAll(".c58").forEach((n) => {
        ...
        u.mount();
        DialogNamespace.refreshSplideOnDialogShown(i, u);
      });
    });
  })(document),
  (function (n) {
        ...
        t.ok &&
          t.json().then((t) => {
            if (!t.Error) {
              ...
              n.querySelector(".timestamp").innerHTML =
                `${e} as of ${t.TimeStamp}`;
              return;
            }
        ...
        r.ok &&
          r.json().then((r) => {
            if (!r.Error) {
              ...
              l.replaceChildren(s);
              t.querySelector(".timestamp").innerHTML =
                `${o} as of ${r.Response.timeStamp}`;
              return;
            }
  ...
  (function (n, t) {
    ...
    function u(n, t = 0) {
      if (n !== null) {
        ...
        f
          .getAt(e)
          .button.querySelector(".button-progress-bar").style.backgroundSize =
          `${o}% 100%`;
      }
    }
    function f(n, t) {
    ...
    t.addEventListener("DOMContentLoaded", function () {
      t.querySelectorAll(".c70").forEach((t) => {
        ...
        DialogNamespace.refreshSplideOnDialogShown(h, r);
  ...
  (function (n) {
    function i(n) {
      ...
      t.add(
        ...
        (t) => {
          const { isDesktop: e } = t.conditions,
            f = n.querySelector(".header");
          if (f) {
            const t = new SplitText(n.querySelector(".header .type-display"), {
                type: "lines",
                linesClass: "lines",
              }),
              i = gsap
          ...
          const i = n.querySelectorAll(".panels section"),
            u = n.querySelectorAll(".dialog-text .dialog-item"),
            o = e ? 64 : 0;
          ScrollTrigger.create({
          ...
          i.forEach((t, r) => {
            function e() {
              const i = n.querySelector(".dialog .cta-link-parent");
              t.bg.dataset.linkUrl == ""
                ? (i.removeAttribute("href"), i.removeAttribute("target"))
                : ((i.href = t.bg.dataset.linkUrl),
                  (i.target = t.bg.dataset.linkTarget));
              const r = n.querySelector(".dialog .background").classList;
              r.forEach((n) => {
                n.includes("background-color-") &&
                  r.replace(n, t.bg.dataset.backgroundColor);
              });
            }
            if (
              ...
              i.to(
                ...
                { y: () => r * -u[0].offsetHeight, duration: 0.5 },
                "fade",
              )
                .to(u[r - 1], { opacity: 0, duration: 0.5 }, "fade")
                .to(u[r], { opacity: 1, duration: 0.5 }, "fade");
            }
          });
        },
      );
    ...
    function t(n, t, i, r) {
      let u = window.getComputedStyle(n).paddingBlock.split(" "),
        f = +u[0].split("px")[0] + +u[1].split("px")[0];
      n.style.height = t + f + "px";
      let e = window.innerWidth >= 768 ? (t - r) / 2 : "0";
      i.forEach((n) => {
        n.style.margin = e + "px 0px";
      });
    }
    function r(n) {
      const f = n.querySelector(".dialog-content"),
        o = n.querySelectorAll(".dialog-text .text-container"),
        r = n.querySelectorAll(".dialog-content .arrow");
      let u = null,
        i = null;
      o.forEach((n) => {
        (i = Math.max(i, n.offsetHeight)), n.offsetHeight == i && (u = n);
      });
      const e = r[0] ? r[0].offsetHeight : "32";
      t(f, i, r, e);
      const s = new ResizeObserver((n) => {
        n.forEach(() => {
          const n = u.offsetHeight;
          n !== i && (t(f, n, r, e), (i = n));
        });
      });
      s.observe(u);
  ...
  (function (n, t) {
    function i(t) {
      ...
      const u = i.querySelectorAll(".card-item"),
        f = function (t) {
          return (
            parseInt(n.getComputedStyle(t).paddingTop, 10) +
            parseInt(n.getComputedStyle(t).paddingBottom, 10)
          );
        },
        e = function (t) {
        ...
        o = Array.from(u).reduce(
          (n, t, i) => (i % 2 == 0 ? n + t.offsetHeight + f(t) : n),
          0,
        ),
        s = Array.from(u).reduce((n, t, i) => {
          if (Math.abs(i % 2) === 1) {
            const r = i === 1 ? e(t) : 0;
            return n + t.offsetHeight + f(t) + r;
          }
          return n;
        }, 0);
  ...
  (function (n, t) {
    function rt(n) {
      ...
      return (
        i.forEach((n) => {
          const i = n.dataset.cvxKeywords.split(/\s*,\s*/),
            r = n.querySelector(`.${f}`).textContent.toLowerCase();
          t.push({ title: r, keywords: i });
        }),
        t
      );
    }
    function ut(n, t) {
      const r = {},
        f = t.querySelectorAll(`.filter-button.${i}`),
        u = [];
      return (
        f.forEach((n) => {
        ...
        u.forEach((t) => {
          ...
          n.forEach((n, t) => {
            n.title.startsWith(i) &&
              (r[t] = {
                startingIndices: [0],
                matchedString: n.title.slice(0, 1),
              });
          });
        }),
        r
    ...
    function ft(n, t) {
      if (t) {
        ...
        return (
          n.forEach((n, t) => {
            let o = n.keywords.find((n) => n.toLowerCase().startsWith(i))
              ? !0
              : !1;
            const u = [],
              e = n.title;
            let f = e.indexOf(i, 0);
            while (f >= 0) u.push(f), (f = e.indexOf(i, f + 1));
            u.length > 0
              ? (r[t] = {
                  startingIndices: u,
                  matchedString: e.slice(u[0], u[0] + i.length),
                })
              : o && (r[t] = { keywordMatch: o });
          }),
          r
        );
      }
    }
    function et({ startingIndices: t, matchedString: n }, i) {
      if (t && n) {
        const e = i.querySelector(`.${r} .${f}`).textContent;
        let o = "",
          s = 0,
          u = 0;
        t.forEach((t) => {
          (u = t + n.length),
            (o += `${e.substring(s, t)}<mark class="highlight">${e.substring(t, u)}</mark>`),
            (s = u);
        });
        o += e.substring(u);
        i.querySelector(`.${r} .${f}`).innerHTML = o;
      }
    }
    function v(n) {
      n.forEach((n) => {
        const t = n.querySelector(`.${r} .${f}`);
    ...
    function y(t, r, u) {
      ...
      f.innerHTML = "";
      const o = r.querySelectorAll(`.${e}`);
      if (
        (v(o),
        o.forEach((n) => n.classList.remove(i)),
        t && Object.entries(t).length > 0)
      ) {
      ...
      s.classList.add(...["type-subhead", "text-base", "text-center"]);
      s.textContent = `No results for ${u}`;
      f.appendChild(s);
    ...
    function p(n) {
      ...
      v(r);
      r.forEach((n) => n.classList.remove(i));
      t.classList.remove("filtered");
    }
    function ot(n) {
      const r = n.querySelector(".filter-search"),
        u = n.querySelectorAll(".filter-button"),
        f = n.querySelector(`.${s}`),
        e = rt(f);
      r.addEventListener("input", (n) => {
        u.forEach((n) => n.classList.remove(i)),
      ...
      u.forEach((t) => {
        t.addEventListener("click", (t) => {
          if (
            (t.preventDefault(), (r.value = ""), t.target.classList.contains(i))
          ) {
            t.target.classList.remove(i);
            p(n);
            return;
          }
          u.forEach((n) => n.classList.remove(i));
          t.target.classList.add(i);
          y(ut(e, n), f);
        });
      });
    ...
    function d(n) {
      return new Promise((t) => {
        const i = n.querySelector(".accordion-collapse"),
          u = n.querySelector(`.${r}`),
          f = bootstrap.Collapse.getOrCreateInstance(i);
        f.hide();
        i.addEventListener("hidden.bs.collapse", () => {
      ...
      t.forEach((t) => {
        ...
        i.addEventListener("click", (t) => {
          if (i.classList.contains("collapsed")) {
            ...
            o(`#${t.target.closest(".accordion-item").id}`, n);
            return;
          }
          g();
          o("", n);
        ...
        u.addEventListener("show.bs.collapse", () => {
          i.classList.remove("collapsed"), i.setAttribute("aria-expanded", !0);
        });
    ...
    function vt(n, t) {
      ...
      i.forEach((t) => {
        ...
        i.id = t.TopicID ? t.TopicID : "";
        i.dataset.cvxItemid = t.ItemID ? t.ItemID : "";
        i.dataset.cvxKeywords = t.Keywords ? t.Keywords : "";
        i.querySelector(".accordion-header").id = o;
        i.querySelector(`.${r} .${f}`).innerText = t.Name;
        i.querySelector(`.${r}`).dataset.bsTarget = `#${e}`;
        i.querySelector(`.${r}`).setAttribute("aria-controls", `#${e}`);
        i.querySelector(".accordion-collapse").setAttribute(
          "aria-labelledby",
          `#${o}`,
        );
        i.querySelector(".accordion-collapse").id = e;
        u.appendChild(i);
      });
              ...
              .then((r) => {
                r.Error
                  ? ((i.innerHTML = u),
                    ...
                    console.log(r.Error))
                  : (vt(n, r), ot(n), yt(n), o(t.location.hash, n));
              })
              .catch(function (n) {
                console.log(n);
                i.innerHTML = u;
  ...
  (function (n) {
    ...
    function c(n) {
      ...
      u.add(
        ...
        (i) => {
          const { isDesktop: e, isMobileOrTablet: c } = i.conditions,
            u = gsap.timeline(),
            l = parseFloat(n.dataset.cvxScrollDuration) || 100,
            o = () => `${t.length * l}%`;
          c ? s(t, u) : h(t, u);
          t.forEach((n, t) => {
            ...
            if (i) {
              const o = i.dataset.cvxMediaDesktop,
                s = i.dataset.cvxScrollAnimation || !1,
          ...
          const a = e ? "top 60%" : "bottom bottom";
          ScrollTrigger.create({
            trigger: n,
            start: `${a}`,
            end: o,
    ...
    n.addEventListener("DOMContentLoaded", function () {
      n.querySelectorAll(".c84").forEach((n) => {
        const t = n.querySelector(".splide"),
          r = t.querySelectorAll(".splide__slide");
        r.length > 1 && t.querySelector(".control").classList.add("show");
        const i = new Splide(t, {
          perPage: 1,
          gap: 0,
          perMove: 1,
          focus: "center",
        ...
        i.mount();
        DialogNamespace.refreshSplideOnDialogShown(t, i);
      });
    });
  })(document),
  (function (n, t) {
  ...
  (function (n) {
    function u(n, r) {
      const f = r.querySelector(t).innerHTML,
        u = n.querySelector(`.dropdown-button ${t}`);
      u &&
        ((u.innerHTML = f),
        r &&
          (r
    ...
    function f(i, u) {
      const f = i.querySelector(".primary-cta");
      if (f) {
        const o = u.dataset.cvxUrl;
        o && (f.href = o);
        const s = f.querySelector(r),
          h = u.querySelector(r);
        s && h && s.replaceWith(h.cloneNode(!0));
        let e = f.querySelector(".visually-hidden");
        e ||
          ((e = n.createElement("span")),
          e.classList.add("visually-hidden"),
          f.appendChild(e));
        const c = u.querySelector(t).innerHTML;
        c && (e.innerHTML = c);
      }
    }
    const i = ".filter-button",
      t = ".button-text",
      r = ".cta-glyphicon";
    n.addEventListener("DOMContentLoaded", function () {
      n.querySelectorAll(".n05r").forEach((n) => {
        const t = n.querySelectorAll(i);
        if (!(!t.length > 0)) {
          const r = t[0];
          u(n, r);
          f(n, r);
  ...
  (function (n, t) {
    const i = t.querySelectorAll('[data-bs-toggle="popover"]');
    i.forEach((n) => {
      const i = n.nextElementSibling;
      if (i && i.classList.contains("popover-content")) {
        n.dataset.bsContent = i.innerHTML;
        const r = new bootstrap.Popover(n);
        n.addEventListener("show.bs.popover", () => {
          t.querySelectorAll(".popover.show").forEach((n) => {
            const i = t.querySelector(`[aria-describedby=${n.id}]`),
              r = bootstrap.Popover.getOrCreateInstance(i);
            r.hide();
          });
        });
        n.addEventListener("inserted.bs.popover", (n) => {
          const i = n.target.getAttribute("aria-describedby");
          if (i) {
            const u = t.querySelector(`#${i} .close-button`);
            u.addEventListener("click", (n) => {
              n.preventDefault(), r.hide();
            });
          }
        });
