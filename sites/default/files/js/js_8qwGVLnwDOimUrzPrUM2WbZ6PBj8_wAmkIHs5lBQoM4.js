    ...
    if ($(window).width() > 1024) {
      ...
      if (isInitMobile == true) {
        ...
        $(".burgerMenuIconM").click(function () {
          if (
            !$(this)
              .parent(".JindexNaviRightTopSub")
              .parent(".JindexNaviRightTop")
              .siblings(".JindexNaviRightBtm")
              .hasClass("show")
          ) {
  ...
  $(function () {
    ...
    if ($(".JindexImg01 .JgeneralBannerBG").length > 0) {
      initial.fromTo(
        ...
        {
          background:
            "linear-gradient(180deg, rgba(0,0,0,0) 0%, rgba(0,0,0,0) 30%, rgba(0,0,0,0) 60%, rgba(0,0,0,0) 100%)",
        },
        {
          background:
            "linear-gradient(180deg, rgba(0,0,0,0.6) 0%, rgba(0,0,0,0) 30%, rgba(0,0,0,0) 60%, rgba(0,0,0,0.8) 100%)",
        },
        0,
      );
    }
    ...
    setTimeout(function () {
      ...
      $(".JindexNaviContainer")
        .css({ top: "-99px", opacity: 0 })
        .animate({ top: naviTop, opacity: 1 }, 500, function () {
      ...
      if ($(".JsideNaviContainer").length > 0) {
        initial2.fromTo(
          ...
          { right: "0px", opacity: 1, ease: Linear.easeNone },
          0,
        );
      }
      if ($(".JsideNaviFooter").length > 0) {
        initial2.fromTo(
          ...
          { bottom: "25px", opacity: 1, ease: Linear.easeNone },
          0,
        );
      }
      $(".JindexImgContent p")
        .css({ left: "50px", opacity: 0 })
