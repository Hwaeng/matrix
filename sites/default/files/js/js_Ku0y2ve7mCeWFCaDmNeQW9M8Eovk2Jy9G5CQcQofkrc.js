...
window.drupalTranslations = {
  strings: {
    "": {
      ...
      None: "Tiada",
      Options: "Opsyen",
      "Display settings": "Seting pameran",
      "Read more": "Baca lebih lanjut",
      Custom: "Tersuai",
      Tag: "Tag",
      Disabled: "Dinyahbolehkan",
      Done: "Selesai",
      "Enter a keyword": "Cari",
      "Suggestion Keywords": "Cadangan Carian",
      "Suggestion Page": "Cadangan Halaman",
      results: "carian",
      for: "untuk",
      "We found": "Kami mendapati",
      Relevance: "Kaitan",
      "Latest Date": "Tarikh Terkini",
      previous: "sebelumnya",
      next: "seterusnya",
    ...
    e.extend(a.prototype, {
      ...
      _attachDatepicker: function (t, a) {
        ...
        (s = "div" === (i = t.nodeName.toLowerCase()) || "span" === i),
          ...
          ((r = this._newInst(e(t), s)).settings = e.extend({}, a || {})),
          "input" === i
      ...
      _attachments: function (t, a) {
        ...
        a.append && a.append.remove(),
          n &&
            ((a.append = e("<span>").addClass(this._appendClass).text(n)),
          ...
          ("button" !== i && "both" !== i) ||
            ...
            this._get(a, "buttonImageOnly")
              ...
              : ((a.trigger = e("<button type='button'>").addClass(
                  this._triggerClass,
                )),
                r
                  ? a.trigger.html(
                      e("<img>").attr({ src: r, alt: s, title: s }),
                    )
                  : a.trigger.text(s)),
      ...
      _enableDatepicker: function (t) {
        ...
        s.hasClass(this.markerClassName) &&
          ("input" === (a = t.nodeName.toLowerCase())
            ? ((t.disabled = !1),
              r.trigger
                .filter("button")
                .each(function () {
      ...
      _showDatepicker: function (t) {
        ...
        e.datepicker._isDisabledDatepicker(t) ||
          ...
          !1 !==
            (s = (i = e.datepicker._get(a, "beforeShow"))
              ? i.apply(t, [t, a])
              : {}) &&
            (r(a.settings, s),
            (a.lastVal = null),
            ...
            (d = { left: e.datepicker._pos[0], top: e.datepicker._pos[1] }),
            ...
            e.datepicker._updateDatepicker(a),
            (d = e.datepicker._checkOffset(a, d, n)),
            a.dpDiv.css({
              position:
            ...
            a.inline ||
              ...
              (o = e.datepicker._get(a, "duration")),
              a.dpDiv.css(
                "z-index",
                (function (e) {
              ...
              e.effects && e.effects.effect[c]
                ? a.dpDiv.show(c, e.datepicker._get(a, "showOptions"), o)
                : a.dpDiv[c || "show"](c ? o : null),
        ...
        d.length > 0 && s.apply(d.get(0)),
          ...
          n > 1 &&
            a.dpDiv
              ...
              .css("width", 17 * n + "em"),
          a.dpDiv[(1 !== r[0] || 1 !== r[1] ? "add" : "remove") + "Class"](
            "ui-datepicker-multi",
          ),
          a.dpDiv[(this._get(a, "isRTL") ? "add" : "remove") + "Class"](
            "ui-datepicker-rtl",
          ),
          a === e.datepicker._curInst &&
            e.datepicker._datepickerShowing &&
            e.datepicker._shouldFocusInput(a) &&
          ...
          c && c.apply(a.input ? a.input[0] : null, [a]);
      },
      ...
      _adjustDate: function (t, a, i) {
        ...
        this._isDisabledDatepicker(s[0]) ||
          (this._adjustInstDate(r, a, i), this._updateDatepicker(r));
      },
      ...
      _selectDay: function (t, a, i, s) {
        ...
        e(s).hasClass(this._unselectableClass) ||
          ...
          (((r = this._getInst(n[0])).selectedDay = r.currentDay =
            parseInt(e("a", s).attr("data-date"))),
          ...
          M = function (t, i, s) {
            ...
            if (
              (e.each(n, function (e, t) {
                var i = t[1];
                if (a.substr(c, i.length).toLowerCase() === i.toLowerCase())
                  return (r = t[0]), (c += i.length), !1;
              }),
              -1 !== r)
            )
              return r + 1;
              ...
              ? (function (a) {
                  ...
                  for (
                    ...
                    switch (c[2] || "d") {
                      ...
                      case "M":
                        (r += parseInt(c[1], 10)),
                          (n = Math.min(n, e.datepicker._getDaysInMonth(s, r)));
                        break;
                      case "y":
                      case "Y":
                        (s += parseInt(c[1], 10)),
        ...
        if ((ee < 0 && ((ee += 12), te--), G))
          for (
            a = this._daylightSavingAdjust(
              new Date(
                G.getFullYear(),
                G.getMonth() - V[0] * V[1] + 1,
                G.getDate(),
              ),
            ),
              a = $ && a < $ ? $ : a;
            this._daylightSavingAdjust(new Date(te, ee, 1)) > a;
        ...
        for (
          t.drawMonth = ee,
            ...
            i = J
              ? this.formatDate(
                  i,
                  this._daylightSavingAdjust(new Date(te, ee - Q, 1)),
            ...
            s = this._canAdjustMonth(t, -1, te, ee)
              ? e("<a>")
                  ...
                  .append(
                    e("<span>")
                      .addClass(
                        "ui-icon ui-icon-circle-triangle-" + (P ? "e" : "w"),
                      )
                      .text(i),
                  )[0].outerHTML
              : B
            ...
            r = J
              ...
              : r,
            n = this._canAdjustMonth(t, 1, te, ee)
              ? e("<a>")
                  .attr({
                  ...
                  .append(
                    e("<span>")
                      .addClass(
                        "ui-icon ui-icon-circle-triangle-" + (P ? "w" : "e"),
                      )
                      .text(r),
                  )[0].outerHTML
              : B
            ...
            c = this._get(t, "gotoCurrent") && t.currentDay ? Z : U,
            d = J ? this.formatDate(d, c, this._getFormatConfig(t)) : d,
            o = "",
            t.inline ||
              (o = e("<button>")
                .attr({
            ...
            l = "",
            z &&
              (l = e("<div class='ui-datepicker-buttonpane ui-widget-content'>")
                .append(P ? o : "")
                .append(
                  this._isInRange(t, c)
                    ? e("<button>")
            ...
            f = this._get(t, "monthNamesShort"),
            k = this._get(t, "beforeShowDay"),
            D = this._get(t, "showOtherMonths"),
          ...
          for (w = "", this.maxRows = 4, C = 0; C < V[1]; C++) {
            if (
              ((I = this._daylightSavingAdjust(
                new Date(te, ee, t.selectedDay),
              )),
              (x = " ui-corner-all"),
              (Y = ""),
              X)
            ) {
              if (((Y += "<div class='ui-datepicker-group"), V[1] > 1))
                switch (C) {
                  case 0:
                    (Y += " ui-datepicker-group-first"),
                      (x = " ui-corner-" + (P ? "right" : "left"));
                    break;
                  case V[1] - 1:
                    (Y += " ui-datepicker-group-last"),
                      (x = " ui-corner-" + (P ? "left" : "right"));
                    break;
                  default:
            ...
            for (
              Y +=
                ...
                x +
                "'>" +
                (/all|left/.test(x) && 0 === b ? (P ? n : s) : "") +
                (/all|right/.test(x) && 0 === b ? (P ? s : n) : "") +
            ...
            for (
              Y += S + "</tr></thead><tbody>",
                ...
                T = (this._getFirstDayOfMonth(te, ee) - h + 7) % 7,
                A = Math.ceil((T + N) / 7),
                K = X && this.maxRows > A ? this.maxRows : A,
                this.maxRows = K,
                j = this._daylightSavingAdjust(new Date(te, ee, 1 - T)),
                O = 0;
              O < K;
              O++
            ) {
              for (
                ...
                (R = k ? k.apply(t.input ? t.input[0] : null, [j]) : [!0, ""]),
                  (W =
                    ((H = j.getMonth() !== ee) && !m) ||
                    !R[0] ||
                    ($ && j < $) ||
                  ...
                  (L +=
                    "<td class='" +
                    ((M + h + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") +
                    (H ? " ui-datepicker-other-month" : "") +
                    ((j.getTime() === I.getTime() &&
                      ee === t.selectedMonth &&
                      t._keyEvent) ||
                    (y.getTime() === j.getTime() && y.getTime() === I.getTime())
                      ? " " + this._dayOverClass
                      : "") +
                    (W
                    ...
                    (H && !D
                      ...
                      : W
                        ...
                        : "<a class='ui-state-default" +
                          ...
                          "' href='#' aria-current='" +
                          (j.getTime() === Z.getTime() ? "true" : "false") +
                          "' data-date='" +
                          j.getDate() +
                          "'>" +
                          j.getDate() +
      ...
      _generateMonthYearHeader: function (e, t, a, i, s, r, n, d) {
        ...
        if ((D || (v += M + (!r && f && k ? "" : "&#xa0;")), !e.yearshtml))
          if (((e.yearshtml = ""), r || !k))
            v += "<span class='ui-datepicker-year'>" + a + "</span>";
          else {
            for (
