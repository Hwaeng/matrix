...
(function($, Drupal) {
  ...
  Drupal.behaviors.petronasParagraphTabs2 = {
    attach: function(context, settings) {
      ...
      $('.JawardsSlideBodyList a').once('clickSlideTabOverlayItem').click(function(e){
          e.preventDefault();
          $('body').addClass('noScroll');
          ...
          if($(this).attr('href').indexOf('#') >= 0){
              console.log('GOT #');
              var final = $(this).attr('href').replace('#', '');
              console.log('final:', final, $('.JgeneralPopupContainer').attr('id'));
      ...
      $('.JgeneralPopupClose').once('closeSlideTabItemOverlay').click(function(){
          $('body').removeClass('noScroll');
          $(this).parent().parent().parent().parent().fadeOut();
      })


      $('.JprivacySlide a').once('clickSlideTabItem').click(function(){
          var final = $(this).data("page");
          console.log(final);
          $('.JprivacySlide ul li').removeClass('active');
          $(this).parent().addClass('active');
          $('.JprivacySlideBodyOuter > div').fadeOut(300);
          $('.JprivacySlideBodyOuter > div[data-page="' + final + '"]').fadeIn(300);
      });
