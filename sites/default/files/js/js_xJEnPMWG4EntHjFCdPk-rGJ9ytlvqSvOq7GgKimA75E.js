...
(function ($, Drupal) {
  Drupal.behaviors.petronasParagraphTabs2 = {
    attach: function (context, settings) {
      $(".JawardsSlideBodyList a")
        .once("clickSlideTabOverlayItem")
        .click(function (e) {
          e.preventDefault();
          $("body").addClass("noScroll");
          console.log("ready drupal!", $(this).attr("href"));
          ...
          if ($(this).attr("href").indexOf("#") >= 0) {
            ...
            console.log(
              "final:",
              final,
              $(".JgeneralPopupContainer").attr("id"),
            );
            console.log(".JgeneralPopupContainer #" + final);
            $("#" + final).fadeIn();
      ...
      $(".JprivacySlide a")
        .once("clickSlideTabItem")
        .click(function () {
          var final = $(this).data("page");
          console.log(final);
          $(".JprivacySlide ul li").removeClass("active");
          $(this).parent().addClass("active");
          $(".JprivacySlideBodyOuter > div").fadeOut(300);
          $('.JprivacySlideBodyOuter > div[data-page="' + final + '"]').fadeIn(
            300,
          );
        });
    },
