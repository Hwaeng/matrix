    ...
    (() => {
      ...
      class g {
        ...
        static bootCritical() {
          ...
          if (
            ((this.page = m()),
            a.e(1414).then(a.bind(a, 8685)),
            g.check(".preLoader-v5"))
          ) {
            var e = document.querySelector(".hero-banner-carousel");
            null == e || e.classList.add("video-Loader"),
              g.init(a.e(843).then(a.bind(a, 2426)), "preLoaderController");
          }
          if (
            (g.check(".swiper-wrapper") && a.e(9563).then(a.bind(a, 9753)),
            g.check(".enquire--campaign") && a.e(6199).then(a.bind(a, 4077)),
            g.check("[data-video]") &&
              g.init(
            ...
            this.page.includes("-v2") &&
              ...
              g.check(".promo-video.has-bodytype-switch") &&
                g.init(a.e(2078).then(a.bind(a, 1771)), "promoVideoController"),
              ...
              g.check('.block [class^="team-item"]') &&
                a.e(3083).then(a.bind(a, 2720)),
              g.check("section.sp-main-nav-header") &&
                a.e(5694).then(a.bind(a, 8883)),
              g.check("section.promo-block-short-block") &&
                Promise.all([a.e(1888), a.e(1961)]).then(a.bind(a, 1930)),
              g.check("section.promo-media") && a.e(4235).then(a.bind(a, 6442)),
              g.check(".model-promo") && a.e(8544).then(a.bind(a, 6943)),
              g.check(".article-block") && a.e(2207).then(a.bind(a, 3554)),
              g.check(".promo-video") && a.e(2078).then(a.bind(a, 2229)),
              g.check(".video-hover") &&
                g.init(
            ...
            g.check("footer.global-footer") &&
              setTimeout(() => {
                g.init(a.e(5866).then(a.bind(a, 9174)), "globalFooter");
              }, 1e3),
            ...
            g.check("section.explore-grid") &&
              (g.init(a.e(4681).then(a.bind(a, 8597)), "docHeightController"),
              g.init(a.e(9730).then(a.bind(a, 7251)), "exploreGridController")),
            ...
            g.check(".content_link") &&
              g.init(a.e(8838).then(a.bind(a, 6787)), "contentLinkController"),
            g.check(".block-content-v2") && a.e(2163).then(a.bind(a, 1568)),
            g.check("[ol-trigger]") &&
              g.init(
            ...
            switch (this.page) {
              ...
              case "brand-page":
                ...
                break;
              case "enquiry-page":
                a.e(3554).then(a.bind(a, 9931)),
                  a.e(8561).then(a.bind(a, 7672)),
                  g.init(
                    Promise.all([
                      a.e(1888),
                      a.e(4022),
        ...
        static bootNonCritical() {
          console.debug("AM BOOT ncr"),
            ...
            g.check("[data-iframe-resizer]") &&
              g.init(a.e(8604).then(a.bind(a, 6255))),
